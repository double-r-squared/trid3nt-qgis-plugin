#!/usr/bin/env node
// GRACE-2 — job-0253 Stage 3 ROUND 8 (P5 Pelicun chain) — LIVE, ONE browser session.
//
// Runs after the GCS-URI-discipline fix (commit d534f4c, job-0252-agent):
...
const OUT_DIR =
  "/home/nate/Documents/GRACE-2/reports/inflight/job-0253-testing-20260610/evidence";
...
async function main() {
  ...
  console.log("=== job-0253 Stage 3 ROUND 8 (P5 Pelicun chain) LIVE — GCS-URI-discipline verify ===");
  let turns = 0;
  ...
  try {
    ...
    const P5_PROMPT = "Run a flood damage assessment for Fort Myers with Pelicun: model the flood first, then use the returned flood depth layer with the NSI building inventory.";
