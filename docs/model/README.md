...
| **tool** | the derive tools, the registry, how a tool is surfaced, retrieved and picked | MODELED in part: one seam, `tool-plane.sysml` - the session code path and the keyword read |
