...
GENERATED from `docs/model/emission-seam.sysml` by `scripts/model_check.py --view`. Never hand-edited: regenerate it, and `tests/model/test_model_conformance.py` fails while it is stale.
...
| --- | --- | --- |
| **EmissionIsAutomatic** | `emissionSeamPoint`, `outputsSeamPoint`, `pipelineEmitter`, `restyleSurface` | `tests/emission/test_auto_publish_droppable_raster.py::test_intermediate_publishes_too_there_is_no_opt_out`<br/>`tests/emission/test_auto_publish_droppable_raster.py::test_publish_for_emission_is_the_only_seam`<br/>`tests/publishing/test_restyle_surface.py::test_hiding_a_layer_is_the_un_emit_and_unhiding_puts_it_back`<br/>`tests/publishing/test_restyle_surface.py::test_hiding_a_layer_nobody_published_refuses_rather_than_creating_one`<br/>`plugin/tests/test_raster_render.py::test_a_visibility_flip_on_a_row_already_seen_reaches_the_layer_tree` |
| **OneScalePerQuantity** | `presetFamily`, `publishPath` | `tests/emission/test_presets.py::test_one_range_spans_a_compared_set`<br/>`tests/emission/test_presets.py::test_a_shared_range_beats_a_read_and_the_legend_stops_naming_percentiles`<br/>`tests/emission/test_presets.py::test_a_data_policy_reads_the_range_off_the_layer_and_says_so`<br/>`tests/scripts/test_animation_legend_stability.py::test_the_scale_is_resolved_over_the_whole_run_never_one_frame`<br/>`tests/scripts/test_animation_legend_stability.py::test_the_animation_paints_what_the_published_raster_of_that_quantity_paints`<br/>`tests/emission/test_publish_layer_legend.py::test_the_layer_ships_the_qml_the_map_loads_over_that_same_range`<br/>`tests/emission/test_outputs_seam.py::test_a_mesh_entry_paints_the_group_it_declares_on_the_published_range`<br/>`tests/scripts/test_animation_legend_stability.py::test_the_published_range_is_found_by_quantity_not_by_the_title_it_was_painted_under`<br/>`tests/scripts/test_animation_legend_stability.py::test_a_log_ramp_takes_the_published_top_and_its_own_declared_floor` |
...
| **StyleIsDeclaredOrKindDefault** | `styleDeclaration`, `styleRowSchema`, `presetFamily`, `publishPath`, `layerMaterializer` | `tests/emission/test_presets.py::test_the_family_is_four_kinds_and_every_one_of_them_writes_a_document`<br/>`tests/emission/test_presets.py::test_a_declaration_that_names_no_parameters_gets_its_kinds_bare_default`<br/>`tests/emission/test_presets.py::test_a_quantity_parameterises_the_preset_it_never_mints_one`<br/>`tests/fetchers/test_router_spec_loader.py::test_a_style_row_naming_a_kind_outside_the_family_is_refused_at_registration`<br/>`tests/fetchers/test_router_spec_loader.py::test_a_style_row_naming_a_geometry_outside_the_family_is_refused`<br/>`plugin/tests/test_raster_render.py::test_the_legends_qml_reaches_load_named_style`<br/>`plugin/tests/test_raster_render.py::test_a_vectors_declared_symbol_is_what_the_read_back_reports`<br/>`tests/emission/test_publish_layer_legend.py::test_a_vector_row_resolves_through_the_same_seam_without_reading_the_object`<br/>`tests/emission/test_publish_layer_legend.py::test_a_mesh_row_resolves_bound_to_the_group_it_declares`<br/>`tests/emission/test_publish_layer_legend.py::test_the_emission_seam_stamps_the_resolved_row_on_a_vector_it_passes`<br/>`tests/model/test_model_conformance.py::test_the_model_conforms_to_the_tree` |
| **TheModelIsHandedAHandleNotAUri** | `layerRecord`, `pipelineEmitter` | `tests/emission/test_layer_handles.py::test_mint_is_idempotent_per_uri`<br/>`tests/emission/test_layer_handles.py::test_mint_is_monotonic_per_registration_order`<br/>`tests/emission/test_layer_handles.py::test_exact_uri_values_become_short_handles`<br/>`tests/emission/test_layer_handles.py::test_plugin_envelope_keeps_the_real_uri`<br/>`tests/emission/test_layer_handles.py::test_verbatim_registered_uri_dual_accepts`<br/>`tests/emission/test_layer_handles.py::test_short_handle_case_and_padding_tolerant`<br/>`tests/emission/test_layer_handles.py::test_unknown_short_handle_rejects_typed_with_inventory`<br/>`tests/emission/test_layer_handles.py::test_unregistered_object_store_uri_rejects_typed`<br/>`tests/emission/test_layer_handles.py::test_emit_seam_llm_sees_handle_not_uri` |
| **UserChoiceBeatsPreset** | `presetFamily`, `restyleSurface`, `restyleTool` | `tests/emission/test_presets.py::test_the_override_wins_field_by_field_over_the_declaration`<br/>`tests/publishing/test_restyle_surface.py::test_the_ask_beats_the_declared_row_field_by_field`<br/>`tests/publishing/test_restyle_surface.py::test_an_ask_nobody_made_leaves_the_declaration_alone`<br/>`tests/publishing/test_restyle_surface.py::test_a_comparison_paints_every_layer_on_the_one_range`<br/>`plugin/tests/test_raster_render.py::test_a_case_reopen_adopts_its_own_layers_and_loads_no_style_over_them`<br/>`plugin/tests/test_raster_render.py::test_a_different_case_sweeps_the_group_it_did_not_open` |
