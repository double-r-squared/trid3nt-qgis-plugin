...
| --- | --- | --- |
| **APinchedBoundaryIsRefusedByName** | `selafinCliDriver` | `tests/test_telemac_boundary_contract.py::test_a_walk_whose_rings_share_a_node_refuses_naming_them`<br/>`tests/test_telemac_boundary_contract.py::test_a_walk_that_visits_every_node_once_states_nothing`<br/>`tests/test_telemac_boundary_contract.py::test_the_host_re_raises_the_walks_own_refusal_typed` |
