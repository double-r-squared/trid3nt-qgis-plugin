...
GENERATED from `docs/model/mesh-seam.sysml` by `scripts/instruments/model_check.py --view`. Never hand-edited: regenerate it, and `tests/model/test_model_conformance.py` fails while it is stale.
...
| **BoundaryRolesAreContiguousRuns** | `sharedPrimitives`, `om2dAdapter` | `tests/mesh/test_mesh_topology_and_bed.py::test_a_scattered_candidate_boundary_resolves_into_two_contiguous_runs`<br/>`tests/mesh/test_mesh_topology_and_bed.py::test_a_run_that_wraps_the_contours_origin_stays_one_run`<br/>`tests/mesh/test_mesh_topology_and_bed.py::test_one_role_declared_across_two_faces_lands_as_two_sections`<br/>`tests/mesh/test_mesh_topology_and_bed.py::test_a_node_two_declared_faces_both_claim_refuses`<br/>`tests/mesh/test_mesh_topology_and_bed.py::test_a_face_the_mesh_never_reaches_refuses_rather_than_going_unprescribed` |
| **CorrectDataClassAtSetBed** | `sharedPrimitives` | `tests/mesh/test_mesh_topology_and_bed.py::test_the_bed_op_permits_no_ladder_rung_on_the_authors_behalf`<br/>`tests/mesh/test_mesh_topology_and_bed.py::test_a_source_naming_nothing_refuses_rather_than_leaving_a_bedless_mesh`<br/>`tests/mesh/test_mesh_topology_and_bed.py::test_a_conditioning_this_primitive_does_not_perform_refuses`<br/>`tests/mesh/test_mesh_topology_and_bed.py::test_the_interpolation_is_a_visible_default_off_a_declared_roster`<br/>`tests/mesh/test_mesh_topology_and_bed.py::test_the_journal_names_the_rung_that_ACTUALLY_painted_the_bed` |
| **ModelShrinksWithTheTree** | `om2dAdapter`, `regGridAdapter`, `om2dBox` | `tests/mesh/test_mesh_meshers.py::test_the_roster_is_the_meshers_the_tree_carries`<br/>`tests/mesh/test_mesh_om2d.py::test_the_roster_is_the_two_meshers_and_nothing_else`<br/>`tests/model/test_model_conformance.py::test_the_model_conforms_to_the_tree` |
