...
| **AnUnreadableFileRefusesRatherThanFallBack** | `selafinIo` | `tests/telemac/test_telemac_result_reader.py::test_a_refusal_names_the_file`<br/>`tests/telemac/test_telemac_result_reader.py::test_a_result_whose_frames_are_cut_short_refuses_by_name`<br/>`tests/telemac/test_telemac_result_reader.py::test_a_pair_that_cannot_be_written_refuses_by_name` |
