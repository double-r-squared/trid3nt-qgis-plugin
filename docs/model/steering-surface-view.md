...
| --- | --- | --- |
| **ACapabilityOnAHostDeckIsAComposite** | `composite`, `wrapper` | `tests/telemac/test_telemac_nestor_dredge.py::test_the_dredge_arms_nestor_and_names_the_files_it_wrote`<br/>`tests/telemac/test_telemac_nestor_dredge.py::test_the_carrier_deck_has_no_dredge_of_its_own`<br/>`tests/telemac/test_telemac_nestor_dredge.py::test_a_dredge_over_a_bed_with_no_stock_refuses_by_name` |
