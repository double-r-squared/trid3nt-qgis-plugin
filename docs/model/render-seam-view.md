...
flowchart LR
    ...
    outputsSeamPoint["OutputsSeamPoint<br/>trid3nt_server/render/outputs_seam.py"]
    ...
    restyleSurface["RestyleSurface<br/>trid3nt_server/workflows/publishing/style.py"]
...
| **UserChoiceBeatsPreset** | `presetFamily`, `restyleSurface`, `restyleTool` | `tests/render/test_presets.py::test_the_override_wins_field_by_field_over_the_declaration`<br/>`tests/publishing/test_restyle_surface.py::test_the_ask_beats_the_declared_row_field_by_field`<br/>`tests/publishing/test_restyle_surface.py::test_an_ask_nobody_made_leaves_the_declaration_alone`<br/>`tests/publishing/test_restyle_surface.py::test_a_comparison_paints_every_layer_on_the_one_range`<br/>`plugin/tests/test_raster_render.py::test_a_case_reopen_adopts_its_own_layers_and_loads_no_style_over_them`<br/>`plugin/tests/test_raster_render.py::test_a_different_case_sweeps_the_group_it_did_not_open` |
