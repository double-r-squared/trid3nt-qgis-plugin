...
| --- | --- | --- |
| **AContinuationIsAnInputOfTheRun** | `opening`, `initialState`, `workerEntrypoint` | `tests/runtime/test_continue_from.py::test_a_run_continues_from_the_file_a_journaled_run_solved`<br/>`tests/runtime/test_continue_from.py::test_a_run_id_with_no_solved_result_is_refused_by_name`<br/>`tests/telemac/test_telemac_reach_staged_inputs.py::test_a_continuation_is_the_runs_input_and_no_template_declares_it`<br/>`tests/telemac/test_telemac_module_surface.py::test_a_continuation_names_the_file_and_nothing_else` |
