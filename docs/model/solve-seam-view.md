...
| --- | --- | --- |
| **AWaterDomainIsClippedToItsMeasuredBed** | `basinDomainClip` | `tests/telemac/test_open_water_domains.py::test_the_basin_is_the_water_the_survey_actually_sounded`<br/>`tests/telemac/test_open_water_domains.py::test_water_the_survey_never_reached_refuses_rather_than_meshing`<br/>`tests/telemac/test_open_water_domains.py::test_the_basin_reads_the_same_survey_it_was_clipped_to` |
