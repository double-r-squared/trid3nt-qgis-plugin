...
| 2026-07-31b | 163 | 72 | 27 | ~55,000 | fold wave 10 (ADR 0056): tier-3 hook contract (2 pure extension points, post_process rejected) + http_json executor; earthquakes/tsunami/volcano folded (-3 coded, net -1,500); remaining-72 ledger: ~15 tier-2-able, ~14 hook-needing, ~43 scoped-job |
