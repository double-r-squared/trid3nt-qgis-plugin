...
models can drive the 147-tool agent, why the default is what it is, and what the routing
benchmarks say.
...
An 8B model cannot reliably pick the right tool out of a registry this size (147 tools
