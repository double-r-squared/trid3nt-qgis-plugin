...
| **SWMM (PySWMM)** | urban stormwater | **in-process** pyswmm (`run_swmm_local`) | none beyond the defaults (pyswmm 2.1.0 in the agent venv) | ~2 min for a 3-block box / 10-yr 1-hr storm -- **see the slow-local caveat below** |
