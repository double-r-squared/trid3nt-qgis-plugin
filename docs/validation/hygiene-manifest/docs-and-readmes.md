...
EXCLUDED with the reason stated: thirteen UNTRACKED sibling files under
`docs/validation/hygiene-manifest/` (contracts.md, docs-decisions.md,
emission.md, plugin.md, scripts-workers.md, tools-processing.md, the four
`trid3nt_server-*.md`, workflows-mesh.md, workflows-runtime-solver-shared.md,
workflows-telemac.md). They are the in-flight products of concurrent lenses,
each owned by the agent writing it; `git ls-files` does not list them and a
second agent rowing another agent's unfinished file would be a claim about work
it did not do. The one TRACKED sibling,
`hygiene-manifest/trid3nt_server-tools-fetchers.md`, IS rowed below.
...
12. **Fate tally across the 191 rows, counted from the table itself**: KEEP 92,
    DELETE 72, REWRITE 26, RE-CUT 1. No row is MOVE - nothing in this scope belongs in another tree
...
files listed: 191 / files read: 191 / rows written: 191
