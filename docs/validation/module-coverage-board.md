...
## MODFLOW 6 (USGS MF6, ALL MODEL TYPES: GWF, GWT, GWE, PRT) (10 modules)
...
Today: Not surfaced as a TRID3NT tool today; TRID3NT currently runs SFINCS (screening-grade coastal/pluvial) and HEC-RAS (US-standard 1D/2D) for this fidelity band per the model-fidelity-ladder doctrine. TELEMAC-2D is queued as a refinement-grade unstructured-mesh alternative (reference_telemac_modules_templates.md).
