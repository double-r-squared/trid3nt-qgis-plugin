...
![Every layer the run published, stacked and framed on the result (run 01M2GN2534D6GMNFVJ89C3SGHS)](telemac_bed_scour/telemac_bed_scour.png)

*Every layer the run published, stacked and framed on the result (run 01M2GN2534D6GMNFVJ89C3SGHS)*

![The solve, frame by frame (run 01M2GN2534D6GMNFVJ89C3SGHS)](telemac_bed_scour/telemac_bed_scour_animation.gif)

*The solve, frame by frame (run 01M2GN2534D6GMNFVJ89C3SGHS)*

![final frame (run 01M2GN2534D6GMNFVJ89C3SGHS)](telemac_bed_scour/telemac_bed_scour_final_frame.png)

*final frame (run 01M2GN2534D6GMNFVJ89C3SGHS)*

![marker concentration - the chart the run persisted (run 01M2GN2534D6GMNFVJ89C3SGHS)](telemac_bed_scour/telemac_bed_scour_chart_marker_concentration.png)
