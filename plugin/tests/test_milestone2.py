...
layer-group clearing + frame-sequence animation grouping. No QGIS required
(Qt widgets excluded, as in milestone 1).

Run via ``make test`` from plugin/ (the stub server needs ``websockets``;
