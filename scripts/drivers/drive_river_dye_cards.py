...
def main() -> int:
    ...
    # The release-point acceptance cases are a named case, not a resolution
    # variant of the canary, and the filename is what says so.
