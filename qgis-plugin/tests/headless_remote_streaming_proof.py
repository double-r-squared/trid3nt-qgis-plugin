...
anything:
    ...
    python3 qgis-plugin/tests/headless_remote_streaming_proof.py
...
from trid3nt.net.trid3nt_client import LayerEvent  # noqa: E402
from trid3nt.render import layers as L  # noqa: E402
