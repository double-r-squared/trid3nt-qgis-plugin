...
from trid3nt_server.agent.workflows.telemac.run_telemac import TELEMAC3D_SOLVER_NAME

logger = logging.getLogger("trid3nt_server.agent.workflows.telemac.stratified_flow")
