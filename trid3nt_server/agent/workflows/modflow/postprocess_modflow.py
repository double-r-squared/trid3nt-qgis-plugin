...
logger = logging.getLogger("trid3nt_server.agent.workflows.modflow.postprocess_modflow")
...
def postprocess_modflow(
    ...
    *,
    ...
    try:
        from trid3nt_server.agent.workflows.modflow.modflow_mesh import emit_modflow_mesh_artifact
...
# local mf6 6.5.0 smoke fixture (workers/modflow/fixtures/csub_smoke):
...
def postprocess_subsidence(
    ...
    *,
    ...
    try:
        from trid3nt_server.agent.tools.processing.charts_common import build_subsidence_timeseries_chart
...
def postprocess_capture_zone(
    ...
    *,
    ...
    Example usage (module-level docstring smoke test)::
        ...
        from trid3nt_server.agent.workflows.modflow.postprocess_modflow import postprocess_capture_zone
...
# local mf6 6.5.0 smoke fixture (workers/modflow/fixtures/sfr_smoke):
...
def postprocess_stream_reaches(
    ...
    *,
    ...
    try:
        from trid3nt_server.agent.tools.processing.charts_common import build_depletion_timeseries_chart, build_reach_profile_chart
...
def postprocess_saltwater_intrusion(
    ...
    *,
    ...
    chart_payload: dict[str, Any] | None = None
    try:
        from trid3nt_server.agent.tools.processing.charts_common import build_saltwater_wedge_chart
