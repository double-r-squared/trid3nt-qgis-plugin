...
from trid3nt_server.agent.tools.search.search_tools.search_tools import _tokenize
...
logger = logging.getLogger("trid3nt_server.agent.tools.search.search_spatial_functions.search_spatial_functions")
...
def _default_data_path() -> Path:
    ...
    # -> trid3nt_server/ is parents[4]
    here = Path(__file__).resolve()
    return here.parents[4] / "agent" / "data" / "duckdb_spatial_functions.json"
