...
logger = logging.getLogger("trid3nt_server.agent.tools.search.search_tools.search_tools")
...
def _default_corpus_path() -> Path:
    ...
    # agent/tools/search/search_tools/search_tools.py -> trid3nt_server/ is parents[4]
    here = Path(__file__).resolve()
    return here.parents[4] / "agent" / "data" / "tool_query_corpus.yaml"
