...
The wave and coastal readers. Each emits ONE peak COG as the map anchor and
narration carrier; the time animation rides the result SELAFIN itself,
published as a mesh layer, so NO per-frame COGs are written."""
