...
| `products.py` | A solved reach to its map layers, its scalars and its chart spec: one reader per question, bound as the module's own output, each naming the product it publishes. |
