...
| `water_temperature/` | `telemac_water_temperature` - how warm a reach gets under a week of real weather: the WAQTEL heat budget over the hourly RAWS record the `Atmosphere` composite carries onto the deck, and the temperature series where the ask places it. |
