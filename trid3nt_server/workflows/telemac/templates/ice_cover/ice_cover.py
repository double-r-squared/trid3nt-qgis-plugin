...
class DATA:
    ...
    # The seed is on a lake rather than in a channel where no reach cuts, so the
    # producer is a LADDER: the reach, else the waterbody the seed stands in,
    # which is a closed body and names no runs.
    domain = Data.domain(
