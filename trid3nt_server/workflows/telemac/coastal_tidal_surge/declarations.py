...
class PARAMS:
    ...
    series_type = Param(
        door=doors.QUESTION, default="observed",
    ...
    # -- the gauge series --------------------------------------------------- #
    station = Param(
        door=doors.USER, optional=True, consequence="physics",
        derived_when_absent=(
    ...
    datum_offset_m = Param(
        door=doors.SCENARIO, optional=True,
    ...
    bathy_source = Param(
        door=doors.SCENARIO, default="noaa_demall",
        consequence="physics",
    ...
    friction_law = Param(
        door=doors.CONSTANT, default=3, type=int,
    ...
    wind_speed_mps = Param(
        door=doors.SCENARIO, default=0.0, bounds=(0.0, 80.0),
    ...
    wind_direction_from_deg = Param(
        door=doors.SCENARIO, default=0.0,
    ...
    time_step_s = Param(
        door=doors.CONSTANT, default=20.0, bounds=(1.0, 600.0),
