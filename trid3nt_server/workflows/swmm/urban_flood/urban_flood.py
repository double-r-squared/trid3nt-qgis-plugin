...
logger = logging.getLogger(
    "trid3nt_server.workflows.swmm.urban_flood.urban_flood"
)
...
_SWMM_URBAN_FLOOD_METADATA = AtomicToolMetadata(
    ...
    gate_spec=GateSpec(
        kind="solver",
        estimate_provider="trid3nt_server.gates.cards.solver_confirm:estimate_swmm_granularity",
        pin_provider="trid3nt_server.gates.cards.solver_confirm:pin_swmm_granularity",
        levers=(
...
async def model_swmm_urban_flood(
    ...
    *,
    ...
    if _os.environ.get("TRID3NT_SWMM_REGISTRY_QUANTITIES", "").lower() in (
        ...
        try:
            from trid3nt_server.workflows.swmm.postprocess_swmm import publish_swmm_quantities
