...
logger = logging.getLogger("trid3nt_server.workflows.modflow.postprocess_modflow")
...
#: Declared in the style contract.
...
#: (J9). Declared in the style contract by the
...
#: declared in the style contract, which also owns the quantity -> preset row.
...
#: the style contract, which also owns the quantity -> preset row.
...
def postprocess_modflow(
    ...
    *,
    ...
    try:
        from trid3nt_server.workflows.modflow.modflow_mesh import emit_modflow_mesh_artifact
...
#: continuous head / water-table style preset (the style contract).
...
def postprocess_capture_zone(
    ...
    *,
    ...
    Example usage (module-level docstring smoke test)::
        ...
        from trid3nt_server.workflows.modflow.postprocess_modflow import postprocess_capture_zone
