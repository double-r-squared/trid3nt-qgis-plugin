...
logger = logging.getLogger("trid3nt_server.workflows.openquake.psha.psha")
...
_OPENQUAKE_PSHA_METADATA = AtomicToolMetadata(
    ...
    gate_spec=GateSpec(
        kind="solver",
        estimate_provider="trid3nt_server.gates.cards.solver_confirm:estimate_psha",
...
# workers.openquake.entrypoint --run-id <id> --manifest-uri <uri>``
...
def openquake_local_spec() -> Any:
    ...
    # ``workers.openquake.*`` and ``workers._raster_postprocess``.
