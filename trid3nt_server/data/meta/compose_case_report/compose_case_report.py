...
from trid3nt_server.data.processing.query_point_hazard.query_point_hazard import layers_from_case, resolve_case_id
...
logger = logging.getLogger("trid3nt_server.data.meta.compose_case_report.compose_case_report")
...
def _layer_stats_line(layer: dict[str, Any], tmpdir: str) -> str:
    ...
    from trid3nt_server.data._uri_util import _strip_query, _unwrap_tile_template
...
async def compose_case_report(
    ...
    **Errors:** ``CaseReportInputError`` (no case identifiable),
    ...
    from trid3nt_server.data.processing.compute_exposure_summary.compute_exposure_summary import get_session_exposure
