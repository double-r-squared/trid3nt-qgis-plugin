...
logger = logging.getLogger("trid3nt_server.data.search.search_tools.search_tools")
...
def _default_corpus_path() -> Path:
    ...
    # data/search/search_tools/search_tools.py -> trid3nt_server/ is parents[3]
...
def _compose_corpus_from_tree() -> dict[str, list[str]]:
    ...
    residual = server_dir / "data" / "tool_query_corpus.yaml"
