...
catalog cache live in ``trid3nt_server.data.search.catalog_common``.
"""
...
from trid3nt_server.data.search.ogc_adapter import OGCAdapterError, fetch_ogc_layer
...
logger = logging.getLogger("trid3nt_server.data.search.search_data_catalog.search_data_catalog")
