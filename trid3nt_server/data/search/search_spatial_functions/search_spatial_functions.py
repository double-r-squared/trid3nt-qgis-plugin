...
from trid3nt_server.data.search.search_tools.search_tools import _tokenize
...
logger = logging.getLogger("trid3nt_server.data.search.search_spatial_functions.search_spatial_functions")
