...
from trid3nt_server.data.fetchers.imagery._satellite_slider import rgb_array_to_cog_bytes
...
logger = logging.getLogger("trid3nt_server.data.fetchers.imagery._goes_archive_core")
