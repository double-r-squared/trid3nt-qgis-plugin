...
from trid3nt_server.data.processing._gdal_runner import translate_to_cog as _translate_to_cog
...
logger = logging.getLogger("trid3nt_server.data.processing.compute_blended_composite.compute_blended_composite")
