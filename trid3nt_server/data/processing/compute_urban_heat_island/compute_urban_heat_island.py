...
logger = logging.getLogger("trid3nt_server.data.processing.compute_urban_heat_island.compute_urban_heat_island")
    ...
    with tempfile.TemporaryDirectory(prefix="trid3nt_uhi_") as tmpdir:
        ...
        try:
            ...
            if lst_uri is not None:
                ...
                try:
                    from trid3nt_server.data.fetchers.climate.fetch_modis_lst.fetch_modis_lst import fetch_modis_lst
