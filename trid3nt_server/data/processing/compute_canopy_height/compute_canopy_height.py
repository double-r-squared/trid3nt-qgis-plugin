...
logger = logging.getLogger("trid3nt_server.data.processing.compute_canopy_height.compute_canopy_height")
...
def _resolve_cog_from_result(run_result: Any, batch_run_id: str) -> str | None:
    ...
    from trid3nt_server.data.simulation.solver.solver import _get_runs_bucket, _try_get_completion_s3  # type: ignore[attr-defined]
