...
from trid3nt_server.data.fetchers.climate.lookup_precip_return_period import lookup_precip_return_period as _df
...
logger = logging.getLogger("trid3nt_server.data.processing.compute_idf_curve.compute_idf_curve")
