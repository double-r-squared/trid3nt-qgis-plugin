...
from trid3nt_server.data.fetchers.imagery import _pc_stac
...
logger = logging.getLogger("trid3nt_server.data.processing.compute_change_detection.compute_change_detection")
...
def compute_change_detection(
    ...
    **_extra_ignored: Any,
    ...
    with tempfile.TemporaryDirectory(prefix="trid3nt_change_") as tmpdir:
        if precomputed:
