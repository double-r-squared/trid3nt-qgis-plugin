...
if TYPE_CHECKING:  # annotation-only; the runtime import is lazy (see below).
    from trid3nt_server.workflows.swmm.swmm_hyetograph import HyetographResult
...
def build_swmm_mesh(
    *,
    ...
    from trid3nt_server.workflows.swmm.swmm_hyetograph import (
    ...
    *,
    ...
    with tempfile.TemporaryDirectory(prefix="swmm_solve_", dir=str(workdir)) as td:
        ...
        proc = subprocess.Popen(
            [sys.executable, "-m",
             "trid3nt_server.mesh._swmm_solve_subprocess", job_path],
