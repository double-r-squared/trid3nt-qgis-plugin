...
logger = logging.getLogger("trid3nt_server.mesh.modflow_package_validation")
...
def resolve_mf6_binary() -> str | None:
    ...
    if onpath:
        return onpath
    # repo-root bin/mf6 (this file: <repo>/trid3nt_server/mesh/..)
    repo_bin = Path(__file__).resolve().parents[2] / "bin" / "mf6"
