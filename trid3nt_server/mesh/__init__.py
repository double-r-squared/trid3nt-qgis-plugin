...
boundary (the worker Dockerfiles COPY only ``workers/*``): MODFLOW's DIS
constructor (``workers/modflow/dis_grid.py``), SWAN's ``_grid_geometry``
(``workers/swan/deck_builder.py``), and TELEMAC's gmsh channel mesher.
They keep their paradigm-native derivation; this layer owns the SERVER surface.
"""

from __future__ import annotations

from trid3nt_server.mesh.coastal_tin import (
    CoastalTinError,
    CoastalTinSpec,
...
from trid3nt_server.mesh.hecras_geometry import (
    HECRAS_2D_AREAS_GROUP,
    read_2d_flow_area_cells,
)
from trid3nt_server.mesh.mesh_preview import (
