...
from trid3nt_server.agent.tools.simulation.pelicun.postprocess_pelicun.postprocess_pelicun import (  # noqa: E402
...
def test_postprocess_pelicun_s3_download_failure_wraps_io_error(monkeypatch) -> None:
    ...
    import trid3nt_server.agent.tools.cache as cache_mod
    from trid3nt_server.agent.tools.simulation.pelicun.postprocess_pelicun.postprocess_pelicun import PelicunPostprocessIOError
...
def test_nonfinite_ds_mean_raises_schema_error() -> None:
    ...
    from trid3nt_server.agent.tools.simulation.pelicun.postprocess_pelicun.postprocess_pelicun import PelicunPostprocessSchemaError
