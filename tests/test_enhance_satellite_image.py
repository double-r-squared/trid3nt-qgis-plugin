...
from trid3nt_server.data.processing.enhance_satellite_image.enhance_satellite_image import (
...
def test_enhance_cache_hit_skips_fetch(tmp_path, monkeypatch_local_cache):
    ...
    import trid3nt_server.data.processing.enhance_satellite_image.enhance_satellite_image as mod
