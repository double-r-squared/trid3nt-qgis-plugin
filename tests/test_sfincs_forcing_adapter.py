...
The adapter (``trid3nt_server.workflows.sfincs.sfincs_forcing_adapter``) is the seam that
...
from trid3nt_server.workflows.sfincs import sfincs_forcing_adapter as A
