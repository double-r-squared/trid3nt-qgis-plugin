...
def test_open_source_is_context_manager():
    from trid3nt_server.data.processing.extract_landcover_class.extract_landcover_class import _open_source
...
def test_extract_landcover_open_source_s3_reads_clean_under_gc(monkeypatch):
    import trid3nt_server.data.processing.extract_landcover_class.extract_landcover_class as elc
    data = _categorical_geotiff_bytes()
