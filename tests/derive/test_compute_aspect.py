...
from trid3nt_server.tools.derive.compute_aspect.compute_aspect import (
    AspectComputeError,
    _run_gdaldem_aspect,
    compute_aspect,
)
...
def test_compute_aspect_cache_miss_writes(fake_storage):
    ...
    with patch(
        "trid3nt_server.tools.derive.compute_aspect.compute_aspect._download_dem_bytes",
        return_value=fake_dem,
    ) as mock_download, patch(
        "trid3nt_server.tools.derive.compute_aspect.compute_aspect._run_gdaldem_aspect",
...
def test_compute_aspect_gdaldem_failure_raises_aspect_compute_error():
    ...
    with patch(
        ...
        "trid3nt_server.tools.derive.compute_aspect.compute_aspect._get_gdaldem_bin",
