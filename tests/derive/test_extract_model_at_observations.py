...
from trid3nt_server.tools.derive.extract_model_at_observations import extract_model_at_observations as exmod
from trid3nt_server.tools.derive.extract_model_at_observations.extract_model_at_observations import (
    PairedObsLayerURI,
...
def test_nearest_wet_window_keeps_the_first_cell_of_a_tie() -> None:
    ...
    from trid3nt_server.tools.derive.extract_model_at_observations.extract_model_at_observations import (  # noqa: E501
        _nearest_wet_sample,
    )
