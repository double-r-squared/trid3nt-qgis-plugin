...
from trid3nt_server.tools.processing.clip_raster_to_polygon.clip_raster_to_polygon import (
...
def test_cache_miss_then_hit_skips_mask(tmp_path):
    ...
    original_mask = __import__(
        "trid3nt_server.tools.processing.clip_raster_to_polygon.clip_raster_to_polygon", fromlist=["_mask_and_write"]
    )._mask_and_write
    ...
    with patch(
        "trid3nt_server.tools.processing.clip_raster_to_polygon.clip_raster_to_polygon._mask_and_write",
