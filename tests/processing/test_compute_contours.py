...
from trid3nt_server.tools.processing.compute_contours.compute_contours import (
    ContourComputeError,
    _derive_interval_m,
...
def test_run_gdal_contour_invocation_args():
    ...
    with patch(
        "trid3nt_server.tools.processing.compute_contours.compute_contours._get_gdal_contour_bin",
...
def test_compute_contours_layer_uri_shape(fake_storage):
    ...
    with patch(
        "trid3nt_server.tools.processing.compute_contours.compute_contours._download_dem_bytes",
        return_value=fake_dem,
    ), patch(
        "trid3nt_server.tools.processing.compute_contours.compute_contours._run_gdal_contour",
...
def test_compute_contours_bbox_fetches_dem(fake_storage):
    ...
    with patch(
        "trid3nt_server.tools.processing.compute_contours.compute_contours.fetch_dem",
