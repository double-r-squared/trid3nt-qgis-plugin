...
def test_publish_layer_vector_returns_benign_and_registers_nothing(
    ...
    calls: list[tuple] = []
    monkeypatch.setattr(
        "trid3nt_server.render.publish.observe_published_layer",
...
def test_publish_layer_auto_translates_no_overview_cog(
    ...
    monkeypatch.setattr(
        "trid3nt_server.render.publish._read_raster_bytes", _fake_read
    )
    monkeypatch.setattr(
        "trid3nt_server.render.publish._write_overview_cog", _fake_write
    )
...
def test_publish_layer_overview_cog_published_unchanged(
    ...
    monkeypatch.setattr(
        "trid3nt_server.render.publish._read_raster_bytes",
        lambda uri: good,
    )
    ...
    monkeypatch.setattr(
        "trid3nt_server.render.publish._write_overview_cog", _must_not_write
    )
