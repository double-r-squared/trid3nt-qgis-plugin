...
async def test_vector_layer_inlines_geojson_into_session_state(
    ...
    monkeypatch.setattr(
        "trid3nt_server.render.pipeline_emitter._read_vector_uri_as_geojson", fake_reader,
    )
...
async def test_vector_layer_inline_geojson_failure_is_non_fatal(
    ...
    monkeypatch.setattr(
        "trid3nt_server.render.pipeline_emitter._read_vector_uri_as_geojson", boom,
    )
...
def test_classify_tool_return_recognizes_all_failed_shapes() -> None:
    from trid3nt_server.render.pipeline_emitter import _classify_tool_return
...
async def test_legend_lifted_from_publish_stash_by_uri(
    ...
    from trid3nt_server.render.publish import _stash_legend_for_uri
    from trid3nt_contracts.execution import LegendKey
