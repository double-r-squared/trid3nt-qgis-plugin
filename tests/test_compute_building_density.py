...
import trid3nt_server.agent.tools.processing.compute_building_density.compute_building_density as cbd
from trid3nt_server.agent.tools import TOOL_REGISTRY
from trid3nt_server.agent.tools.processing.compute_building_density.compute_building_density import (
...
def test_cache_miss_invokes_fetch_fn_and_writes_store():
    ...
    with patch(
        "trid3nt_server.agent.tools.processing.compute_building_density.compute_building_density._fetch_building_density_bytes",
        side_effect=fake_fetch,
    ), patch(
        "trid3nt_server.agent.tools.processing.compute_building_density.compute_building_density.read_through",
