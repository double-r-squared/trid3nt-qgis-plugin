...
from trid3nt_server.agent.tools.fetchers._router.executors import library_delegate
from trid3nt_server.agent.tools.fetchers._router.hooks import register_hook, HOOK_REGISTRY
...
def test_registration_rejects_resolve_without_delegate():
    from trid3nt_server.agent.tools.fetchers._router.registration import _validate_hooks
    from trid3nt_server.agent.tools.fetchers._router.hooks import HookResolutionError
