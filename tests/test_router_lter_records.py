...
from trid3nt_server.agent.tools.fetchers._router.hooks import lter_records as lr
...
def _inject_transport(monkeypatch):
    ...
    from trid3nt_server.agent.tools.fetchers._router.executors import chained_resolution
