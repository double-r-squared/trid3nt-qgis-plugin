...
from trid3nt_server.agent.tools.fetchers._router.hooks import nwm_streamflow as ns
from trid3nt_server.agent.tools.fetchers._router.hooks.nwm_streamflow import (
