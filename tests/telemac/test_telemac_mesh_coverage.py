...
from trid3nt_server.workflows.telemac.errors import ReachMeshUncovered
from trid3nt_server.workflows.telemac.templates.reach import measure_mesh_coverage
...
async def test_a_mesh_with_no_projected_zone_cannot_be_measured(tmp_path):
    ...
    with pytest.raises(TelemacError, match="cannot be measured"):
