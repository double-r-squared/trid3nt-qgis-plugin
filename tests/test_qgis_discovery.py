...
from trid3nt_server.data.search.qgis_discovery import qgis_discovery
from trid3nt_server.data.search.qgis_discovery.qgis_discovery import (
    CURATED_ALLOWLIST,
    MAX_LIST_RESULTS,
    SOURCE_CLASS,
...
def test_qgis_process_raises_runtime_error_when_no_backend(monkeypatch) -> None:
    ...
    from trid3nt_server.data.meta.passthroughs.passthroughs import qgis_process
