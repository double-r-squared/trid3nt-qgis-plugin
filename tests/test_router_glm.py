...
from trid3nt_server.agent.tools.fetchers._router.hooks import glm as GLM
from trid3nt_server.agent.tools.fetchers.imagery._goes_archive_core import _grid_for_bbox


def _load_group_frame_layers():
    spec = importlib.util.spec_from_file_location(
        "_plugin_temporal_gfl_glm", "qgis-plugin/trid3nt/render/temporal.py"
    )
