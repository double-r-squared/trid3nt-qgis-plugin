...
def test_tolerate_page_error_returns_partial():
    from trid3nt_server.agent.tools.fetchers._router.executors import chained_resolution as ch
    ...
    import trid3nt_server.agent.tools.fetchers._router.executors.chained_resolution as CH
    orig = CH._get
    CH._get = fake_get
    try:
