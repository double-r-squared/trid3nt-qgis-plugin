...
from trid3nt_server.tools.fetchers._router import router as _router_mod
...
def test_apply_envelope_strips_protected_keys():
    ...
    from trid3nt_server.tools.fetchers._router.hooks import register_hook
