...
from trid3nt_server.data.processing.digitize_water_body import digitize_water_body as wb_mod
from trid3nt_server.data.processing.digitize_water_body.digitize_water_body import (
    _METADATA,
    _STYLE_PRESET,
    WaterBodyBboxError,
