...
from trid3nt_server.tools.search import catalog_common as catalog_mod
from trid3nt_server.tools.search import ogc_adapter as ogc_mod
from trid3nt_server.tools.search.catalog_common import CatalogNotFoundError, load_catalog
from trid3nt_server.tools.search.fetch_from_catalog.fetch_from_catalog import fetch_from_catalog
from trid3nt_server.tools.search.search_data_catalog.search_data_catalog import search_data_catalog
...
def fake_storage_patched(monkeypatch):
    ...
    from trid3nt_server.tools.search.fetch_from_catalog import fetch_from_catalog as _cf_mod
    from trid3nt_server.tools.search.search_data_catalog import search_data_catalog as _cs_mod
