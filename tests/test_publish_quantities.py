...
from trid3nt_server.workflows.shared import publish_quantities as pq
from trid3nt_server.workflows.shared.cog_io import CogIoError
from trid3nt_server.workflows.shared.publish_quantities import (
    QuantityExecError,
...
def _patch_cog_io():
    ...
    return (
        ...
        patch(
            "trid3nt_server.workflows.shared.publish_quantities.cog_io.cog_bbox_4326",
            return_value=(-1.0, 2.0, 3.0, 4.0),
        ),
        patch(
            "trid3nt_server.workflows.shared.publish_quantities.cog_io.safe_unlink",
            return_value=None,
        ),
    )
