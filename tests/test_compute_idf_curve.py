...
from trid3nt_server.tools.processing.compute_idf_curve import compute_idf_curve as idf_mod
...
from trid3nt_server.tools.processing.compute_idf_curve.compute_idf_curve import (
    IdfCurveInputError,
