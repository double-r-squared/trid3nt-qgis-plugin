...
def test_dispatch_publish_layer_still_skips_file_uri(reset_seams) -> None:
    with patch("trid3nt_server.emission.publish.publish_layer") as fake_publish:
...
def test_publish_layer_raw_s3_for_plume_preset(
    ...
    from trid3nt_server.emission import publish as pl_mod
    from trid3nt_server.emission.publish import pop_legend_for_uri, publish_layer
