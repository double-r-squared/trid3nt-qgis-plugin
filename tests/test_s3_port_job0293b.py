...
def test_postprocess_pelicun_download_s3_stages_and_wraps_errors(monkeypatch):
    from trid3nt_server.data.simulation.pelicun.postprocess_pelicun.postprocess_pelicun import (
...
def test_postprocess_pelicun_tool_unlinks_s3_staged_file(monkeypatch):
    ...
    from trid3nt_server.data.simulation.pelicun.postprocess_pelicun import postprocess_pelicun as mod
