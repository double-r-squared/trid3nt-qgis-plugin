...
from trid3nt_server.data.processing.compute_blended_composite.compute_blended_composite import (
...
def test_compute_blended_composite_registered():
    ...
    assert entry.module == "trid3nt_server.data.processing.compute_blended_composite.compute_blended_composite"
...
def test_compute_blended_composite_cache_hit_skips_fetch(fake_storage):
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        with patch(
            "trid3nt_server.data.processing.compute_blended_composite.compute_blended_composite._run_blend",
