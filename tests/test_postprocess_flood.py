...
def test_frame_names_match_web_parseFrameToken_step_pattern(tmp_path: Path) -> None:
    ...
    from trid3nt_server.agent.workflows.sfincs.postprocess_sfincs import _extract_depth_frames
...
def test_postprocess_flood_emits_peak_plus_frames_with_distinct_uris(
    ...
    from trid3nt_server.agent.workflows.sfincs.postprocess_sfincs import postprocess_flood
