...
from trid3nt_server.tools.processing.extract_landcover_class.extract_landcover_class import (
    LandcoverClassError,
...
def test_cache_miss_hit_skips_recompute():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        from trid3nt_server.tools.processing.extract_landcover_class import extract_landcover_class as mod
