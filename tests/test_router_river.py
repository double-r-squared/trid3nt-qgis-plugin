...
from trid3nt_server.agent.tools.fetchers._router.hooks import overpass
from trid3nt_server.agent.tools.fetchers._router.spec import load_spec_from_path

RIVER_SPEC = load_spec_from_path(
    Path(__file__).resolve().parents[1]
    / "src/trid3nt_server/agent/tools/fetchers/hydrology/fetch_river_geometry/source.yaml"
)
