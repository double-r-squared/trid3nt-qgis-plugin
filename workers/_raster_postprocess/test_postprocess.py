...
# Make the repo root importable so ``workers._raster_postprocess`` works
# from the agent venv (the conftest at workers does this for the worker
# tree; this test is collected under the package dir).
_REPO_ROOT = Path(__file__).resolve().parents[2]
if str(_REPO_ROOT) not in sys.path:
    sys.path.insert(0, str(_REPO_ROOT))

from workers._raster_postprocess import (  # noqa: E402
    band_stats as _band_stats,
)
from workers._raster_postprocess import cog as _cog  # noqa: E402
from workers._raster_postprocess import manifest as _manifest  # noqa: E402
from workers._raster_postprocess import postprocess as _pp  # noqa: E402
from workers._raster_postprocess import sfincs_reader as _reader  # noqa: E402
