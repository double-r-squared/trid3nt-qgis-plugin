...
# workers/_raster_postprocess/ with the quadtree (sfincs_deckbuilder)
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if build_mode:
            ...
            from workers._sfincs_build import (
                build_sfincs_deck,
                build_sfincs_quadtree_deck,
                validate_job_spec,
            )
            from workers._sfincs_build.deck import SFINCSSetupError
