...
delivered the pinned container (``Dockerfile``, image
``trid3nt/elmfire:dev``, release 2025.0526) with tutorial 01 + verification
case 01 reproduced in-container.

(this package's ``deck_builder``) delivers the deterministic input
...
(dispatch + composer) and (ECR/Batch infra) build on this.
"""
