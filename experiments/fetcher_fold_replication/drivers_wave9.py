...
try:
    from trid3nt_server.agent.tools.fetchers.socioeconomic.fetch_hrsl_population import (  # noqa: E402
        fetch_hrsl_population as hrsl_mod,
    )
except ImportError:
    hrsl_mod = None
try:
    from trid3nt_server.agent.tools.fetchers.climate.fetch_chirps_precipitation import (  # noqa: E402
