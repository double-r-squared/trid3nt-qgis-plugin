...
try:
    from trid3nt_server.agent.tools.fetchers.hazard.fetch_landfire_fuels import (  # noqa: E402
        fetch_landfire_fuels as lf_mod,
    )
except ImportError:
    lf_mod = None
try:
    from trid3nt_server.agent.tools.fetchers.hazard.fetch_usfs_canopy_fuels import (  # noqa: E402
        fetch_usfs_canopy_fuels as us_mod,
    )
except ImportError:
    us_mod = None
try:
    from trid3nt_server.agent.tools.fetchers.climate.fetch_modis_lst import (  # noqa: E402
