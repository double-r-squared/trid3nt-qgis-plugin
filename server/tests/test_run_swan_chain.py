...
def test_swan_registered_in_solver_workflow_registry():
    ...
    from trid3nt_server.agent.workflows.swan.run_swan import (
        SWAN_SOLVER_NAME,
...
def test_swan_wave_field_typed_error_on_missing_bbox():
    ...
    from trid3nt_server.agent.workflows.swan.wave_field.wave_field import swan_wave_field
...
def test_read_swan_mat_fields_reads_hs_tp_dir(tmp_path: Path):
    from trid3nt_server.agent.workflows.swan.postprocess_swan import read_swan_mat_fields
...
def test_compute_swan_wave_metrics_on_synthetic_grid():
    from trid3nt_server.agent.workflows.swan.postprocess_swan import compute_swan_wave_metrics
...
def test_postprocess_swan_end_to_end_shape(tmp_path: Path):
    ...
    from trid3nt_server.agent.workflows.swan import postprocess_swan as ps
...
def test_upsample_for_cog_preserves_values_and_mask():
    from trid3nt_server.agent.workflows.swan.postprocess_swan import _upsample_for_cog
...
def test_written_hs_cog_has_overviews(tmp_path: Path):
    ...
    from trid3nt_server.agent.workflows.swan.postprocess_swan import (
        _COG_MIN_DIM_PX,
        _write_hs_cog_4326,
    )
...
def test_coerce_boundary_snaps_net_outgoing_dir_inward():
    ...
    from trid3nt_server.agent.workflows.swan.run_swan import _coerce_boundary_inward
...
def test_normalize_boundary_side_words_and_phrases():
    ...
    from trid3nt_server.agent.workflows.swan.wave_field.wave_field import _normalize_boundary_side
