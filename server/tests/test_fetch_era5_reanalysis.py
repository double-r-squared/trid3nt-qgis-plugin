...
from trid3nt_server.agent.tools.fetchers.climate.fetch_era5_reanalysis.fetch_era5_reanalysis import (
    ERA5AuthError,
    ERA5EmptyError,
    ERA5InputError,
    ERA5MissingKeyError,
...
def test_mocked_happy_path_total_precipitation(monkeypatch):
    ...
    with patch(
        "trid3nt_server.agent.tools.fetchers.climate.fetch_era5_reanalysis.fetch_era5_reanalysis.read_through",
