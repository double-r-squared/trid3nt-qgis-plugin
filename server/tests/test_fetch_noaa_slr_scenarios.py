...
from trid3nt_server.tools.fetchers.ocean.fetch_noaa_slr_scenarios.fetch_noaa_slr_scenarios import (
...
def test_fetch_features_ok_mocked():
    ...
    with patch(
        "trid3nt_server.tools.fetchers.ocean.fetch_noaa_slr_scenarios.fetch_noaa_slr_scenarios.httpx.Client"
    ) as mock_client_cls:
...
def test_cache_miss_then_hit(monkeypatch):
    ...
    with patch(
        ...
        "trid3nt_server.tools.fetchers.ocean.fetch_noaa_slr_scenarios.fetch_noaa_slr_scenarios.read_through",
