...
from trid3nt_server.tools.fetchers.hazard.fetch_mtbs_burn_severity.fetch_mtbs_burn_severity import (
    MTBSBboxError,
    MTBSError,
    MTBSUpstreamError,
    MTBSYearRangeError,
...
def test_mocked_50_features_returns_50_polygons():
    ...
    with patch(
        "trid3nt_server.tools.fetchers.hazard.fetch_mtbs_burn_severity.fetch_mtbs_burn_severity._mtbs_query_one_page",
        return_value=_mtbs_response(features, exceeded=False),
    ), patch(
        "trid3nt_server.tools.fetchers.hazard.fetch_mtbs_burn_severity.fetch_mtbs_burn_severity.read_through",
