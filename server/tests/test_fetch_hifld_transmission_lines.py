...
from trid3nt_server.agent.tools.fetchers.hazard.fetch_hifld_transmission_lines.fetch_hifld_transmission_lines import (
...
def test_end_to_end_mocked_fetch_and_serialize():
    ...
    from trid3nt_server.agent.tools.fetchers.hazard.fetch_hifld_transmission_lines import fetch_hifld_transmission_lines as mod
