...
from trid3nt_server.tools.fetchers.weather.fetch_raws_weather.fetch_raws_weather import (
...
def test_date_range_too_wide_raises():
    ...
    from trid3nt_server.tools.fetchers.weather.fetch_raws_weather.fetch_raws_weather import _MAX_DATE_RANGE_DAYS
...
def test_no_raws_stations_in_bbox_raises_empty_error():
    ...
    with patch(
        "trid3nt_server.tools.fetchers.weather.fetch_raws_weather.fetch_raws_weather._discover_raws_stations_in_bbox",
        return_value=[],
    ), patch(
        "trid3nt_server.tools.fetchers.weather.fetch_raws_weather.fetch_raws_weather.read_through",
...
def test_mocked_end_to_end_writes_fgb_to_cache():
    ...
    with patch(
        "trid3nt_server.tools.fetchers.weather.fetch_raws_weather.fetch_raws_weather._fetch_raws_bytes",
...
def test_station_discovery_filters_non_raws():
    ...
    with patch(
        "trid3nt_server.tools.fetchers.weather.fetch_raws_weather.fetch_raws_weather._http_get",
