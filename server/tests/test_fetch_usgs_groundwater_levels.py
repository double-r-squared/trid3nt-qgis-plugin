...
def test_happy_path_builds_layer_and_valid_fgb():
    ...
    with patch(
        "trid3nt_server.agent.tools.fetchers.hydrology.fetch_usgs_groundwater_levels.fetch_usgs_groundwater_levels._http_get",
        side_effect=fake_http_get,
    ), patch(
        "trid3nt_server.agent.tools.fetchers.hydrology.fetch_usgs_groundwater_levels.fetch_usgs_groundwater_levels.read_through",
