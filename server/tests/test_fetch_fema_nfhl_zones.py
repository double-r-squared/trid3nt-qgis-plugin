...
from trid3nt_server.agent.tools.fetchers.hazard.fetch_fema_nfhl_zones.fetch_fema_nfhl_zones import (
...
def test_user_agent_header_sent_on_request():
    ...
    with patch("trid3nt_server.agent.tools.fetchers.hazard.fetch_fema_nfhl_zones.fetch_fema_nfhl_zones.httpx.Client", FakeClient):
...
def test_5_feature_response_writes_fgb_with_5_polygons():
    ...
    with patch(
        "trid3nt_server.agent.tools.fetchers.hazard.fetch_fema_nfhl_zones.fetch_fema_nfhl_zones._nfhl_query_one_page",
        return_value=fake_geojson,
    ), patch(
        "trid3nt_server.agent.tools.fetchers.hazard.fetch_fema_nfhl_zones.fetch_fema_nfhl_zones.read_through",
...
def test_pagination_advances_objectid_cursor():
    ...
    from trid3nt_server.agent.tools.fetchers.hazard.fetch_fema_nfhl_zones.fetch_fema_nfhl_zones import _PAGE_SIZE
...
def test_cache_miss_invokes_fetch_then_hit_skips():
    ...
    with patch(
        "trid3nt_server.agent.tools.fetchers.hazard.fetch_fema_nfhl_zones.fetch_fema_nfhl_zones._fetch_nfhl_bytes",
