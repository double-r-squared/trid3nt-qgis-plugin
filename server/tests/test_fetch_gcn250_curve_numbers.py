...
from trid3nt_server.agent.tools.fetchers.soil.fetch_gcn250_curve_numbers.fetch_gcn250_curve_numbers import (
...
def test_cache_miss_invokes_fetch_and_writes():
    ...
    with patch(
        "trid3nt_server.agent.tools.fetchers.soil.fetch_gcn250_curve_numbers.fetch_gcn250_curve_numbers._fetch_gcn250_bytes",
        side_effect=fake_fetch,
    ), patch(
        "trid3nt_server.agent.tools.fetchers.soil.fetch_gcn250_curve_numbers.fetch_gcn250_curve_numbers.read_through",
