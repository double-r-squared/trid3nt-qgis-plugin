...
from trid3nt_server.agent.tools.fetchers.socioeconomic.fetch_hrsl_population.fetch_hrsl_population import (
...
def test_antarctica_bbox_raises_empty_via_fetch():
    ...
    """
    from trid3nt_server.agent.tools.fetchers.socioeconomic.fetch_hrsl_population.fetch_hrsl_population import _fetch_hrsl_bytes
...
def test_cache_miss_invokes_fetch_fn_and_writes_store():
    ...
    with patch(
        "trid3nt_server.agent.tools.fetchers.socioeconomic.fetch_hrsl_population.fetch_hrsl_population._fetch_hrsl_bytes",
        side_effect=fake_inner,
    ), patch(
        "trid3nt_server.agent.tools.fetchers.socioeconomic.fetch_hrsl_population.fetch_hrsl_population.read_through",
