...
from trid3nt_server.agent.tools.processing.compute_zonal_statistics.compute_zonal_statistics import (
    CRSMismatchError,
...
def test_cache_hit_on_repeat_call():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        with patch(
            "trid3nt_server.agent.tools.processing.compute_zonal_statistics.compute_zonal_statistics._zonal_stats_raster_zone",
