...
from trid3nt_server.tools.fetchers.ocean.fetch_noaa_coops_currents.fetch_noaa_coops_currents import (
...
def test_discover_stations_in_bbox_filters_correctly():
    ...
    with patch(
        "trid3nt_server.tools.fetchers.ocean.fetch_noaa_coops_currents.fetch_noaa_coops_currents._http_get",
...
def test_fetch_tool_cache_miss_then_hit():
    ...
    with (
        patch("trid3nt_server.tools.fetchers.ocean.fetch_noaa_coops_currents.fetch_noaa_coops_currents._http_get",
              side_effect=fake_http_get),
        patch("trid3nt_server.tools.fetchers.ocean.fetch_noaa_coops_currents.fetch_noaa_coops_currents.read_through",
