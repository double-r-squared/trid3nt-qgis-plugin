...
from trid3nt_server.agent.tools.fetchers.hazard.fetch_epa_frs_facilities.fetch_epa_frs_facilities import (
    EPA_NEPASSIST_BASE,
    FACILITY_PROGRAMS,
    FRS_UNION_PROGRAMS,
    EpaFrsInputError,
...
def test_end_to_end_mocked(tmp_path, monkeypatch):
    ...
    """
    from trid3nt_server.agent.tools.fetchers.hazard.fetch_epa_frs_facilities import fetch_epa_frs_facilities as mod
...
def test_live_houston_returns_facilities():
    from trid3nt_server.agent.tools.fetchers.hazard.fetch_epa_frs_facilities.fetch_epa_frs_facilities import _fetch_frs_bytes
