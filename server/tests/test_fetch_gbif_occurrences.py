...
from trid3nt_server.agent.tools.fetchers.biodiversity.fetch_gbif_occurrences.fetch_gbif_occurrences import (
    GBIFError,
    GBIFInputError,
    GBIFUpstreamError,
...
def test_mocked_happy_path_single_page():
    ...
    with patch(
        "trid3nt_server.agent.tools.fetchers.biodiversity.fetch_gbif_occurrences.fetch_gbif_occurrences.read_through",
        side_effect=_make_read_through_injector(fake_gcs),
    ), patch(
        "trid3nt_server.agent.tools.fetchers.biodiversity.fetch_gbif_occurrences.fetch_gbif_occurrences.httpx.Client"
    ) as mock_client_cls:
