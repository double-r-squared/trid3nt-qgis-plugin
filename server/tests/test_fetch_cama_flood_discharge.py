...
from trid3nt_server.tools.fetchers.hydrology.fetch_cama_flood_discharge.fetch_cama_flood_discharge import (
    CaMaFloodEmptyError,
    CaMaFloodInputError,
...
def _route_for(synthetic_nc_bytes: bytes, base_url: str, year: int) -> dict[str, bytes | str | None]:
    ...
    from trid3nt_server.tools.fetchers.hydrology.fetch_cama_flood_discharge.fetch_cama_flood_discharge import _candidate_filenames
...
def test_mocked_happy_path_writes_cog(monkeypatch):
    ...
    with patch(
        "trid3nt_server.tools.fetchers.hydrology.fetch_cama_flood_discharge.fetch_cama_flood_discharge.httpx.Client",
        side_effect=fake_client_factory,
    ), patch(
        "trid3nt_server.tools.fetchers.hydrology.fetch_cama_flood_discharge.fetch_cama_flood_discharge.read_through",
