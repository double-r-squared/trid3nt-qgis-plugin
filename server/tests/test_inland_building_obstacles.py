...
def _inland_chain_patches(build_sfincs_mock):  # noqa: ANN001, ANN201 — test helper
    ...
    mod = "trid3nt_server.workflows.sfincs.model_flood_scenario.model_flood_scenario"
    return [
...
async def test_inland_with_buildings_passes_uri_and_subgrid() -> None:
    ...
    with contextlib.ExitStack() as stack:
        ...
        stack.enter_context(
            patch(
                "trid3nt_server.tools.fetchers.socioeconomic.fetch_buildings.fetch_buildings.fetch_buildings",
