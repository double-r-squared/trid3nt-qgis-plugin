...
from trid3nt_server.tools.processing.clip_raster_to_bbox.clip_raster_to_bbox import (
    ClipRasterError,
    clip_raster_to_bbox,
)
...
def test_clip_quadrant_produces_smaller_raster():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        with patch(
            "trid3nt_server.tools.processing.clip_raster_to_bbox.clip_raster_to_bbox._download_raster_bytes",
            return_value=fake_raster_bytes,
        ), patch(
            "trid3nt_server.tools.processing.clip_raster_to_bbox.clip_raster_to_bbox._get_source_crs",
...
def test_cache_miss_writes_and_hit_skips_gdal():
    ...
    with patch(
        ...
        "trid3nt_server.tools.processing.clip_raster_to_bbox.clip_raster_to_bbox._run_gdal_translate_clip_with_srs",
...
def test_gdalwarp_path_when_crs_differs():
    ...
    with patch(
        ...
        "trid3nt_server.tools.processing.clip_raster_to_bbox.clip_raster_to_bbox._run_gdalwarp_clip",
