...
from trid3nt_server.agent.tools.fetchers.weather.fetch_mrms_qpe.fetch_mrms_qpe import (
    _CONUS_BBOX,
    _METADATA,
    _NODATA,
    _grib2_to_geotiff,
...
def test_fetch_mrms_qpe_lowercase_24h_accepted(tmp_path):
    ...
    with patch(
        "trid3nt_server.agent.tools.fetchers.weather.fetch_mrms_qpe.fetch_mrms_qpe._fetch_mrms_qpe_bytes",
        side_effect=fake_fetch_bytes,
    ), patch(
        "trid3nt_server.agent.tools.fetchers.weather.fetch_mrms_qpe.fetch_mrms_qpe.read_through",
...
def test_live_fetch_24h_conus_writes_evidence_file(tmp_path):
    ...
    import numpy as np
    import rasterio
    from trid3nt_server.agent.tools.fetchers.weather.fetch_mrms_qpe.fetch_mrms_qpe import _fetch_mrms_qpe_bytes
