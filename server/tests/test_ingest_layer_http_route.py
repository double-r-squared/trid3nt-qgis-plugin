...
from trid3nt_server.agent.tools.meta.register_case_layer.register_case_layer import (
    CaseNotFoundError,
...
def test_ingest_layer_file_oversized_413_before_read(monkeypatch):
    ...
    monkeypatch.setattr(tool_catalog_http, "_upload_layer_file_fn", lambda: _never)
    from trid3nt_server.agent.tools.meta.register_case_layer.register_case_layer import MAX_INGEST_BYTES
