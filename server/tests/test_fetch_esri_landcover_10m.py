...
from trid3nt_server.tools.fetchers.terrain.fetch_esri_landcover_10m import fetch_esri_landcover_10m as lc_mod
from trid3nt_server.tools.fetchers.terrain.fetch_esri_landcover_10m.fetch_esri_landcover_10m import (
...
def test_tile_grid_small_bbox_single_tile() -> None:
    ...
    from trid3nt_server.tools.fetchers.terrain.fetch_esri_landcover_10m.fetch_esri_landcover_10m import _plan_tile_grid, _TILE_DEG2
...
def test_tile_grid_coverage_and_no_gaps() -> None:
    ...
    from trid3nt_server.tools.fetchers.terrain.fetch_esri_landcover_10m.fetch_esri_landcover_10m import _plan_tile_grid
