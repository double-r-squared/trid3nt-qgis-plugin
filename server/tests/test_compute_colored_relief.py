...
from trid3nt_server.tools.processing.compute_colored_relief.compute_colored_relief import (
    ColoredReliefError,
    _VALID_RAMPS,
    _write_ramp_file,
...
def test_each_ramp_produces_multi_band_output(ramp: str):
    ...
    try:
        ...
        from trid3nt_server.tools.processing.compute_colored_relief.compute_colored_relief import _run_colored_relief
...
def test_cache_hit_skips_fetch_fn():
    ...
    from trid3nt_server.tools.processing.compute_colored_relief.compute_colored_relief import _COMPUTE_COLORED_RELIEF_METADATA
...
def test_compute_colored_relief_returns_correct_layer_uri_shape():
    ...
    with patch("trid3nt_server.tools.processing.compute_colored_relief.compute_colored_relief._run_colored_relief",
        ...
        with patch(
            "trid3nt_server.tools.processing.compute_colored_relief.compute_colored_relief.read_through",
