...
from trid3nt_server.agent.tools.fetchers.climate.fetch_us_drought_monitor.fetch_us_drought_monitor import (
    DM_LABELS,
...
def _patch_client(mock_response):
    return patch("trid3nt_server.agent.tools.fetchers.climate.fetch_us_drought_monitor.fetch_us_drought_monitor.httpx.Client")
...
def test_fetch_features_ok_mocked():
    ...
    with patch(
        "trid3nt_server.agent.tools.fetchers.climate.fetch_us_drought_monitor.fetch_us_drought_monitor.httpx.Client"
    ) as mock_client_cls:
...
def test_cache_miss_then_hit():
    ...
    with patch(
        ...
        "trid3nt_server.agent.tools.fetchers.climate.fetch_us_drought_monitor.fetch_us_drought_monitor.read_through",
