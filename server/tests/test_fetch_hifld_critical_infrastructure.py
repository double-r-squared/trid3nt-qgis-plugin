...
from trid3nt_server.tools.fetchers.hazard.fetch_hifld_critical_infrastructure.fetch_hifld_critical_infrastructure import (
    FACILITY_TYPES,
...
def test_end_to_end_mocked_cache(tmp_path, monkeypatch):
    ...
    from trid3nt_server.tools.fetchers.hazard.fetch_hifld_critical_infrastructure import fetch_hifld_critical_infrastructure as mod
