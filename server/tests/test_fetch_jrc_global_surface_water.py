...
from trid3nt_server.tools.fetchers.hydrology.fetch_jrc_global_surface_water import fetch_jrc_global_surface_water as gsw_mod
from trid3nt_server.tools.fetchers.hydrology.fetch_jrc_global_surface_water.fetch_jrc_global_surface_water import (
