...
from trid3nt_server.agent.tools.processing.compute_ndvi import compute_ndvi as ndvi_mod
from trid3nt_server.agent.tools.processing.compute_ndvi.compute_ndvi import (
    _METADATA,
    _STYLE_PRESET,
    NDVIBboxError,
    NDVINoImageryError,
