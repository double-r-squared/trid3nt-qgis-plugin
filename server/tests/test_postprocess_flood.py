...
def test_frame_names_match_web_parseFrameToken_step_pattern(tmp_path: Path) -> None:
    ...
    from trid3nt_server.workflows.sfincs.postprocess_flood import _extract_depth_frames
...
def test_no_time_dim_falls_back_to_single_peak_layer(tmp_path: Path) -> None:
    ...
    with patch(
        "trid3nt_server.workflows.sfincs.postprocess_flood._upload_cog_to_runs_bucket",
