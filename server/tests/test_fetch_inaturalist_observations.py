...
from trid3nt_server.tools.fetchers.biodiversity.fetch_inaturalist_observations.fetch_inaturalist_observations import (
    INatError,
    INatInputError,
    INatUpstreamError,
    _coerce_taxon_id,
...
def test_happy_path_200_records_writes_fgb_with_points_inside_bbox():
    ...
    with patch(
        "trid3nt_server.tools.fetchers.biodiversity.fetch_inaturalist_observations.fetch_inaturalist_observations.httpx.Client",
        side_effect=make_client,
    ), patch(
        "trid3nt_server.tools.fetchers.biodiversity.fetch_inaturalist_observations.fetch_inaturalist_observations.read_through",
