...
from trid3nt_server.agent.tools.fetchers._router.errors import RouterEmptyError, RouterInputError
from trid3nt_server.agent.tools.fetchers._router.executors import overpass_sidecar
from trid3nt_server.agent.tools.fetchers._router.executors.vector_fgb import features_to_fgb_bytes
from trid3nt_server.agent.tools.fetchers._router.hooks import buildings as BH
...
def test_empty_features_raise_buildings_empty():
    ...
    import trid3nt_server.agent.tools.fetchers._router.executors.overpass_sidecar as osx
