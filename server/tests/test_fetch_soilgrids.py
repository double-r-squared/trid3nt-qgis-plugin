...
from trid3nt_server.tools.fetchers.soil.fetch_soilgrids.fetch_soilgrids import (
    estimate_payload_mb,
    fetch_soilgrids,
...
def test_end_to_end_returns_layeruri(tmp_path):
    ...
    with patch("trid3nt_server.tools.fetchers.soil.fetch_soilgrids.fetch_soilgrids.read_through", side_effect=injector), \
