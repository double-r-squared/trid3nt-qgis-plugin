...
from trid3nt_server.agent.tools.fetchers.hazard.fetch_usgs_earthquakes.fetch_usgs_earthquakes import (
    DEFAULT_WINDOW_DAYS,
    FDSN_RESULT_LIMIT,
    MAX_WINDOW_DAYS,
...
def test_fetch_bytes_empty_raises_no_events(monkeypatch):
    import trid3nt_server.agent.tools.fetchers.hazard.fetch_usgs_earthquakes.fetch_usgs_earthquakes as M
