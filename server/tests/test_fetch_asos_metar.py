...
from trid3nt_server.agent.tools.fetchers.weather.fetch_asos_metar.fetch_asos_metar import (
    ASASMETAREmptyError,
    ASASMETARInputError,
...
def test_no_stations_in_bbox_raises_empty_error():
    ...
    with patch(
        "trid3nt_server.agent.tools.fetchers.weather.fetch_asos_metar.fetch_asos_metar._discover_stations_in_bbox",
        return_value=[],
    ), patch(
        "trid3nt_server.agent.tools.fetchers.weather.fetch_asos_metar.fetch_asos_metar.read_through",
...
def test_mocked_end_to_end_writes_fgb_to_cache():
    ...
    with patch(
        ...
        "trid3nt_server.agent.tools.fetchers.weather.fetch_asos_metar.fetch_asos_metar._fetch_asos_csv_bytes",
