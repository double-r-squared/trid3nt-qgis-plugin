...
def test_geoclaw_composer_register_only_branch_and_fallback():
    import trid3nt_server.workflows.geoclaw.model_dambreak_geoclaw_scenario.model_dambreak_geoclaw_scenario as m
...
def test_openquake_composer_register_only_branch_and_fallback():
    import trid3nt_server.workflows.openquake.model_seismic_hazard_scenario.model_seismic_hazard_scenario as m
...
def test_swmm_composer_register_only_branch_and_fallback():
    import trid3nt_server.workflows.swmm.model_urban_flood_swmm.model_urban_flood_swmm as m
...
def test_landlab_composer_register_only_branch_and_fallback():
    import trid3nt_server.workflows.landlab.model_landslide_scenario.model_landslide_scenario as m
...
def test_read_publish_manifest_absent_pointer_returns_none(monkeypatch):
    ...
    import trid3nt_server.tools.simulation.solver.solver as solver
