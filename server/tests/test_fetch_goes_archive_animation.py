...
from trid3nt_server.agent.tools.fetchers.imagery.fetch_goes_archive_animation import fetch_goes_archive_animation as mod
...
def test_cf_scaling_applied_in_reproject(monkeypatch, tmp_path):
    ...
    """
    import trid3nt_server.agent.tools.fetchers.imagery.fetch_goes_archive_animation.fetch_goes_archive_animation as m
