...
from trid3nt_server.tools.fetchers.weather.fetch_storm_events_db.fetch_storm_events_db import (
    StormEventsArgError,
...
def test_full_name_and_iso_share_cache_key():
    ...
    with patch(
        "trid3nt_server.tools.fetchers.weather.fetch_storm_events_db.fetch_storm_events_db._fetch_storm_events_bytes",
        side_effect=lambda *a, **k: fake_fetch(),
    ), patch(
        "trid3nt_server.tools.fetchers.weather.fetch_storm_events_db.fetch_storm_events_db.read_through",
