...
from trid3nt_server.agent.tools.fetchers.biodiversity.fetch_ebird_observations.fetch_ebird_observations import (
    EBirdAuthError,
    EBirdError,
    EBirdInputError,
...
def test_mocked_happy_path_single_tile():
    ...
    with patch(
        "trid3nt_server.agent.tools.fetchers.biodiversity.fetch_ebird_observations.fetch_ebird_observations.read_through",
        side_effect=_make_read_through_injector(fake_gcs),
    ), patch(
        "trid3nt_server.agent.tools.fetchers.biodiversity.fetch_ebird_observations.fetch_ebird_observations.httpx.Client",
