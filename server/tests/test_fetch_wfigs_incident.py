...
def test_name_resolution_returns_point_bbox_discovery():
    ...
    with patch("trid3nt_server.tools.fetchers.hazard.fetch_wfigs_incident.fetch_wfigs_incident.httpx.Client", _FakeClient), patch(
        "trid3nt_server.tools.fetchers.hazard.fetch_wfigs_incident.fetch_wfigs_incident.read_through", _identity_read_through
    ):
...
def test_contained_fire_resolves_via_yeartodate_when_current_empty():
    ...
    with patch(
        "trid3nt_server.tools.fetchers.hazard.fetch_wfigs_incident.fetch_wfigs_incident.httpx.Client", _FakeClient
    ), patch(
        "trid3nt_server.tools.fetchers.hazard.fetch_wfigs_incident.fetch_wfigs_incident.read_through",
