...
from trid3nt_server.tools.fetchers.biodiversity.fetch_iucn_red_list_range.fetch_iucn_red_list_range import (
    IUCNAuthError,
    IUCNInputError,
    IUCNUpstreamError,
    _resolve_api_key,
...
def test_no_credentials_raises_auth_error_before_network_call(monkeypatch):
    ...
    with patch(
        "trid3nt_server.tools.fetchers.biodiversity.fetch_iucn_red_list_range.fetch_iucn_red_list_range.read_through",
...
def test_secret_ref_resolves_via_module_persistence_seam():
    ...
    import trid3nt_server.tools.fetchers.biodiversity.fetch_iucn_red_list_range.fetch_iucn_red_list_range as iucn_mod
...
def test_mocked_happy_path_emits_one_feature_flatgeobuf(monkeypatch):
    ...
    with patch(
        "trid3nt_server.tools.fetchers.biodiversity.fetch_iucn_red_list_range.fetch_iucn_red_list_range._fetch_iucn_species_payload",
...
def test_mocked_token_invalid_body_raises_auth_error(monkeypatch):
    ...
    from trid3nt_server.tools.fetchers.biodiversity.fetch_iucn_red_list_range import fetch_iucn_red_list_range as mod
