...
def test_suggest_empty_dem_raises(tmp_path: Path) -> None:
    ...
    from trid3nt_server.workflows.swmm.swmm_mesh_builder import (
        SWMMMeshError,
...
def _patch_dem_fetch(monkeypatch, dem_path: str) -> None:
    import trid3nt_server.workflows.swmm.model_urban_flood_swmm.model_urban_flood_swmm as mu
...
async def test_proceed_pins_suggested_resolution(monkeypatch, dem_path: str) -> None:
    from trid3nt_server import server
    from trid3nt_server.workflows.swmm.swmm_mesh_builder import suggest_swmm_resolution
...
def test_clamp_helper_honours_coarser_and_clamps_finer() -> None:
    from trid3nt_server import server
    from trid3nt_server.workflows.swmm.swmm_mesh_builder import SWMMAutoscaleResult
...
def _real_active_cells_at(dem_path: str, res_m: float, representation: str = "drop") -> int:
    ...
    from trid3nt_server.workflows.swmm.swmm_mesh_builder import build_swmm_mesh
