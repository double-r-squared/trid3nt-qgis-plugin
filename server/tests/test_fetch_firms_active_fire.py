...
def test_invalid_map_key_response_raises_auth_error():
    ...
    """
    from trid3nt_server.tools.fetchers.hazard.fetch_firms_active_fire.fetch_firms_active_fire import _fetch_firms_csv
    ...
    with patch(
        "trid3nt_server.tools.fetchers.hazard.fetch_firms_active_fire.fetch_firms_active_fire.requests.get",
...
def test_cache_miss_invokes_fetch_and_writes():
    ...
    with patch(
        "trid3nt_server.tools.fetchers.hazard.fetch_firms_active_fire.fetch_firms_active_fire._fetch_firms_active_fire_bytes",
        side_effect=fake_fetch,
    ), patch(
        "trid3nt_server.tools.fetchers.hazard.fetch_firms_active_fire.fetch_firms_active_fire.read_through",
