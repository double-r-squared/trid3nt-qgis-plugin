...
from trid3nt_server.agent.tools.fetchers.climate.fetch_gridmet.fetch_gridmet import (
    GRIDMETEmptyError,
    GRIDMETInputError,
...
def _build_synthetic_gridmet_dataset(variable: str, bbox, n_days: int = 3):
    ...
    from trid3nt_server.agent.tools.fetchers.climate.fetch_gridmet.fetch_gridmet import _VARIABLES
...
def test_mocked_happy_path_fm100(monkeypatch):
    ...
    with patch(
        "trid3nt_server.agent.tools.fetchers.climate.fetch_gridmet.fetch_gridmet.read_through",
