...
from trid3nt_server.tools.fetchers.biodiversity.fetch_movebank_tracks.fetch_movebank_tracks import (
    MovebankAuthError,
    MovebankInputError,
...
def test_mocked_happy_path_linestring():
    ...
    with patch(
        "trid3nt_server.tools.fetchers.biodiversity.fetch_movebank_tracks.fetch_movebank_tracks.read_through",
        side_effect=_make_read_through_injector(fake_gcs),
    ), patch(
        "trid3nt_server.tools.fetchers.biodiversity.fetch_movebank_tracks.fetch_movebank_tracks.httpx.Client"
    ) as mock_client_cls:
