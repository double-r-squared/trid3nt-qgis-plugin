...
def test_cache_miss_writes_and_hit_skips_recompute():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        call_count = [0]
        from trid3nt_server.tools.processing.clip_vector_to_polygon import clip_vector_to_polygon as cvp_mod
        ...
        with patch(
            "trid3nt_server.tools.processing.clip_vector_to_polygon.clip_vector_to_polygon._clip_vector_locally",
