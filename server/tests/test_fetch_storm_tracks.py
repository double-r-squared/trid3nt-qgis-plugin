...
import trid3nt_server.agent.tools.fetchers.weather.fetch_storm_tracks.fetch_storm_tracks as mod
from trid3nt_server.agent.tools import get_registered_tools
from trid3nt_server.agent.tools.fetchers.weather.fetch_storm_tracks.fetch_storm_tracks import (
    IBTRACS_CSV_BASE,
