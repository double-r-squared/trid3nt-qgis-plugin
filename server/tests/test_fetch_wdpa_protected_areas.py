...
from trid3nt_server.tools.fetchers.biodiversity.fetch_wdpa_protected_areas.fetch_wdpa_protected_areas import (
    WDPABboxError,
...
def test_lowercase_designation_filter_matches_through_public_tool():
    ...
    with patch(
        "trid3nt_server.tools.fetchers.biodiversity.fetch_wdpa_protected_areas.fetch_wdpa_protected_areas._wdpa_query_one_page",
        return_value=_wdpa_response(features, exceeded=False),
    ), patch(
        "trid3nt_server.tools.fetchers.biodiversity.fetch_wdpa_protected_areas.fetch_wdpa_protected_areas.read_through",
