...
from trid3nt_server.agent.tools.fetchers.hazard.fetch_nifc_fire_perimeters.fetch_nifc_fire_perimeters import (
    CONUS_BBOX,
    NIFCFireError,
    NIFCFireInputError,
...
def test_user_agent_header_sent_on_request():
    ...
    with patch("trid3nt_server.agent.tools.fetchers.hazard.fetch_nifc_fire_perimeters.fetch_nifc_fire_perimeters.httpx.Client", FakeClient):
        _fetch_nifc_geojson(
...
def test_10_feature_conus_response_writes_fgb_with_10_polygons():
    ...
    with patch(
        "trid3nt_server.agent.tools.fetchers.hazard.fetch_nifc_fire_perimeters.fetch_nifc_fire_perimeters._fetch_nifc_geojson",
        return_value=fake_geojson,
    ), patch(
        "trid3nt_server.agent.tools.fetchers.hazard.fetch_nifc_fire_perimeters.fetch_nifc_fire_perimeters.read_through",
...
def test_cache_miss_invokes_fetch_fn_then_hit_skips():
    ...
    with patch(
        "trid3nt_server.agent.tools.fetchers.hazard.fetch_nifc_fire_perimeters.fetch_nifc_fire_perimeters._fetch_nifc_bytes",
