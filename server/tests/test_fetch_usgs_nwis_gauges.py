...
from trid3nt_server.tools.fetchers.hydrology.fetch_usgs_nwis_gauges.fetch_usgs_nwis_gauges import (
...
def test_whole_state_bbox_with_state_code_succeeds():
    ...
    with (
        patch("trid3nt_server.tools.fetchers.hydrology.fetch_usgs_nwis_gauges.fetch_usgs_nwis_gauges._http_get", side_effect=fake_http_get),
        patch(
            "trid3nt_server.tools.fetchers.hydrology.fetch_usgs_nwis_gauges.fetch_usgs_nwis_gauges.read_through",
...
def test_iv_happy_path_layer_uri_shape():
    ...
    with (
        patch("trid3nt_server.tools.fetchers.hydrology.fetch_usgs_nwis_gauges.fetch_usgs_nwis_gauges._http_get", return_value=iv_json),
        patch(
            "trid3nt_server.tools.fetchers.hydrology.fetch_usgs_nwis_gauges.fetch_usgs_nwis_gauges.read_through",
            side_effect=_make_read_through_injector(fake_gcs),
        ),
...
def test_window_mode_no_stations_raises(monkeypatch):
    ...
    with (
        patch(
            "trid3nt_server.tools.fetchers.hydrology.fetch_usgs_nwis_gauges.fetch_usgs_nwis_gauges._http_get",
...
def test_live_boise_iv_returns_gauges():
    from trid3nt_server.tools.fetchers.hydrology.fetch_usgs_nwis_gauges.fetch_usgs_nwis_gauges import _fetch_usgs_nwis_gauges_bytes
