...
def test_openquake_registered_in_local_spec_registry() -> None:
    import trid3nt_server.workflows.openquake.model_seismic_hazard_scenario.model_seismic_hazard_scenario as _oq_mod
    del _oq_mod
...
def test_openquake_build_argv_calls_run_oq_py() -> None:
    from trid3nt_server.workflows.openquake.model_seismic_hazard_scenario.model_seismic_hazard_scenario import openquake_local_spec
...
def test_launch_writes_manifest_to_rundir(
    ...
    from trid3nt_server.tools.simulation.solver.solver import launch_local_solver, LocalSolverSpec
