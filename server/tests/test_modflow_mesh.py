...
from trid3nt_server.agent.workflows.modflow import modflow_mesh as mesh_mod
from trid3nt_server.agent.workflows.modflow.modflow_mesh import (
    ModflowMeshError,
...
def test_emit_uploads_mesh_with_head_and_concentration(
    ...
    fake = _FakeS3Client()
    monkeypatch.setattr("trid3nt_server.agent.tools.simulation.solver.solver._get_s3_client", lambda: fake, raising=False)
