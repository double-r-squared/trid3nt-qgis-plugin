...
from trid3nt_server.workflows.sfincs import sfincs_spiderweb as S
...
def test_fetch_storm_tracks_radii_parse_blank_tolerant():
    from trid3nt_server.tools.fetchers.weather.fetch_storm_tracks.fetch_storm_tracks import _parse_ibtracs_csv
