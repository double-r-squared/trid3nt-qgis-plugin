...
from trid3nt_server.agent.tools.fetchers.ocean.fetch_noaa_coops_tides.fetch_noaa_coops_tides import (
...
def test_discover_stations_in_bbox_filters_correctly():
    ...
    with patch(
        "trid3nt_server.agent.tools.fetchers.ocean.fetch_noaa_coops_tides.fetch_noaa_coops_tides._http_get",
...
def test_fetch_tool_cache_miss_then_hit():
    ...
    with (
        ...
        patch(
            "trid3nt_server.agent.tools.fetchers.ocean.fetch_noaa_coops_tides.fetch_noaa_coops_tides.read_through",
...
def test_live_fetch_fort_myers_ian_date():
    ...
    from trid3nt_server.agent.tools.fetchers.ocean.fetch_noaa_coops_tides.fetch_noaa_coops_tides import _fetch_coops_tides_bytes
