...
from trid3nt_server.tools.fetchers.imagery.fetch_goes_satellite.fetch_goes_satellite import (
...
def test_cache_miss_invokes_fetch_fn_and_writes_store():
    ...
    with patch(
        "trid3nt_server.tools.fetchers.imagery.fetch_goes_satellite.fetch_goes_satellite._fetch_goes_bytes",
        side_effect=fake_fetch,
    ), patch(
        "trid3nt_server.tools.fetchers.imagery.fetch_goes_satellite.fetch_goes_satellite.read_through",
...
def test_live_florida_fetch_produces_valid_cog():
    ...
    from trid3nt_server.tools.fetchers.imagery.fetch_goes_satellite import fetch_goes_satellite as gtool
    ...
    with patch(
        ...
        "trid3nt_server.tools.fetchers.imagery.fetch_goes_satellite.fetch_goes_satellite._list_recent_keys",
