...
from trid3nt_server.workflows.shared.model_glm_lightning_animation import model_glm_lightning_animation as anim
from trid3nt_server.workflows.shared.model_glm_lightning_animation.model_glm_lightning_animation import (
    DEFAULT_ACCUM_S,
    GLMAnimEmptyError,
    GLMAnimInputError,
    _frame_buckets,
...
def _wire_synthetic(monkeypatch, *, base_band_seen=None, news_guard=None):
    ...
    import trid3nt_server.tools.fetchers.weather.fetch_glm_lightning.fetch_glm_lightning as glmmod
