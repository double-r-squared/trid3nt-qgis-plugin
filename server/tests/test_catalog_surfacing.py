...
- DEFAULT config (no arm flag): the 27 spec-served sources stay tier="general",
  ambient-declarable; registry == 180 (ADR 0118 +1 schism_tidal_hydro; ADR 0117 +2 living-atlas search+fetch; ADR 0109 +1 hecras_muncie_flood; ADR 0105: -3 standalone composers, atop ADR 0095 -1 fetch_cama_flood_discharge
