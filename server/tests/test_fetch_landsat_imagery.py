...
from trid3nt_server.agent.tools.fetchers.imagery.fetch_landsat_imagery import fetch_landsat_imagery as landsat_mod
from trid3nt_server.agent.tools.fetchers.imagery.fetch_landsat_imagery.fetch_landsat_imagery import (
    _METADATA,
    _STYLE_PRESET,
...
def test_thermal_is_multiband_passthrough() -> None:
    ...
    from trid3nt_server.agent.tools.publish_layer.publish_layer import _is_rgba_or_multiband
