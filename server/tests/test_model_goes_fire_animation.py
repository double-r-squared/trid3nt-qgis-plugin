...
from trid3nt_server.workflows.shared.model_goes_fire_animation.model_goes_fire_animation import (
    DEFAULT_GOES_WINDOW,
    GOES_FIRE_PRODUCTS,
...
def _patch_slider(ts: list[int]):
    ...
    return patch(
        "trid3nt_server.workflows.shared.model_goes_fire_animation.model_goes_fire_animation._read_slider_timestamps",
...
def test_default_run_proceeds_unattended_and_emits_blended_group():
    ...
    with patch.dict(
        ...
        "trid3nt_server.workflows.shared.model_goes_fire_animation.model_goes_fire_animation._safe_overlay_firms",
        _async_none,
    ), patch(
        "trid3nt_server.workflows.shared.model_goes_fire_animation.model_goes_fire_animation._publish_layers",
        _async_empty_dict,
    ):
        result = _run(
            model_goes_fire_animation(
