...
from trid3nt_server.tools.fetchers.socioeconomic.fetch_ghsl_population.fetch_ghsl_population import (
...
def test_deep_south_ocean_raises_empty_via_fetch():
    ...
    """
    from trid3nt_server.tools.fetchers.socioeconomic.fetch_ghsl_population.fetch_ghsl_population import _fetch_ghsl_pop_bytes
...
def test_cache_miss_invokes_fetch_fn_and_writes_store():
    ...
    with patch(
        "trid3nt_server.tools.fetchers.socioeconomic.fetch_ghsl_population.fetch_ghsl_population._fetch_ghsl_pop_bytes",
        side_effect=fake_inner,
    ), patch(
        "trid3nt_server.tools.fetchers.socioeconomic.fetch_ghsl_population.fetch_ghsl_population.read_through",
...
def test_synthetic_single_tile_cog_roundtrip(tmp_path):
    ...
    import trid3nt_server.tools.fetchers.socioeconomic.fetch_ghsl_population.fetch_ghsl_population as mod
