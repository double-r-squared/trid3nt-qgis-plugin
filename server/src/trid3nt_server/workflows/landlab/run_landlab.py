...
_TRID3NT_REPO_ROOT = str(Path(__file__).resolve().parents[5])
...
def register_landlab_solver() -> None:
    ...
    """
    from trid3nt_server.tools.simulation.solver.solver import LOCAL_SOLVER_SPEC_REGISTRY, register_local_solver_spec
