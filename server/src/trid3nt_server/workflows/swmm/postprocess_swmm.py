...
logger = logging.getLogger("trid3nt_server.workflows.swmm.postprocess_swmm")
...
def postprocess_swmm_pollutants(
    ...
    *,
    ...
    from trid3nt_server.workflows.swmm.swmm_mesh_builder import read_quality_routing_continuity
