...
logger = logging.getLogger("trid3nt_server.workflows.shared.model_goes_fire_animation.model_goes_fire_animation")
...
async def _read_slider_timestamps(product: str, satellite: str, sector: str) -> list[int]:
    ...
    """
    try:
        from trid3nt_server.tools.fetchers.imagery._satellite_slider import fetch_slider_timestamps
        from trid3nt_server.tools.fetchers.imagery.fetch_goes_animation.fetch_goes_animation import _band_to_slider_product
