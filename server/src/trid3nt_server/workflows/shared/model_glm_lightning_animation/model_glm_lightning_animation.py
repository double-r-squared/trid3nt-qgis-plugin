...
logger = logging.getLogger("trid3nt_server.workflows.shared.model_glm_lightning_animation.model_glm_lightning_animation")
...
def _grayscale_visible_base(
    ...
    from trid3nt_server.tools.fetchers.imagery.fetch_goes_satellite.fetch_goes_satellite import _download_to_tempfile
...
def _emit_baked_frame(
    ...
    from trid3nt_server.tools.fetchers.weather.fetch_glm_lightning.fetch_glm_lightning import _METADATA as _GLM_METADATA
