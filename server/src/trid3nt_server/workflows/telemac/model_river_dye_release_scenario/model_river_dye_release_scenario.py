...
logger = logging.getLogger("trid3nt_server.workflows.telemac.model_river_dye_release_scenario.model_river_dye_release_scenario")
    ...
    *,
            ...
            if gaia_path:
                ...
                if dep_layers and emitter is not None:
                    ...
                    try:
                        ...
                        dep_pub = dep_raw
                    from trid3nt_server.layer_uri_emit import publish_input_layer  # noqa: WPS433
    ...
    if substance_class == "oil" and emitter is not None:
        try:
            ...
            from trid3nt_server.layer_uri_emit import publish_input_layer  # noqa: WPS433
            from trid3nt_server.tools.simulation.solver.solver import _get_runs_bucket  # noqa: WPS433
...
async def _maybe_emit_chart(emitter: Any, metrics: dict[str, Any], location_name: str) -> None:
    ...
    if cmax is None or peak_t is None:
        return
    from trid3nt_server.tools.processing.charts_common import build_chart_payload  # type: ignore
