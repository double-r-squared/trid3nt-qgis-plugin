...
logger = logging.getLogger("trid3nt_server.workflows.modflow.model_multi_species_scenario.model_multi_species_scenario")
...
async def model_multi_species_scenario(
    ...
    *,
    ...
    from trid3nt_server.tools.simulation.run_modflow_multi_species_tool import run_modflow_multi_species_job
