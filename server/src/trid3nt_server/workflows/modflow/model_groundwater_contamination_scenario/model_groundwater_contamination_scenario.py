...
logger = logging.getLogger(
    "trid3nt_server.workflows.modflow.model_groundwater_contamination_scenario.model_groundwater_contamination_scenario"
)
...
def _extract_contaminant(text: str) -> str | None:
    ...
    from trid3nt_server.tools.processing.aggregate_claims_across_sources.aggregate_claims_across_sources import _extract_contaminants
