...
from trid3nt_server.pipeline_emitter import begin_substeps, current_emitter
...
logger = logging.getLogger(
    "trid3nt_server.workflows.modflow.mine_dewatering.mine_dewatering"
)
...
TEMPLATE_CARD = TemplateCard(
    question='groundwater inflow needed to dewater an open pit + the drawdown cone extent',
    required_inputs=['location (or aoi_latlon)', 'pit_footprint_lonlat'],
    knobs='drain_elevation_m, drain_conductance_m2_day, well_pumping_rate_m3_day, aquifer_k_ms, porosity',
)


_METADATA = AtomicToolMetadata(
    name="modflow_mine_dewatering",
...
async def modflow_mine_dewatering(
    location: str | None = None,
