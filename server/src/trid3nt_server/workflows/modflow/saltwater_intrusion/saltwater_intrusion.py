...
logger = logging.getLogger("trid3nt_server.workflows.modflow.saltwater_intrusion.saltwater_intrusion")
...
TEMPLATE_CARD = TemplateCard(
    question='how far a coastal saltwater wedge intrudes under pumping / sea-level rise (variable-density BUY)',
    required_inputs=['location (or aoi_latlon)'],
    knobs='coastal_transect_latlon, seawater_salinity_ppt, n_vertical_layers, aquifer_k_ms, porosity',
)


_METADATA = AtomicToolMetadata(
    name="modflow_saltwater_intrusion",
...
async def modflow_saltwater_intrusion(
    location: str | None = None,
