...
logger = logging.getLogger(
    "trid3nt_server.workflows.modflow.model_regional_water_budget_scenario.model_regional_water_budget_scenario"
)
...
async def model_regional_water_budget_scenario(
    ...
    *,
    ...
    try:
        ...
        from trid3nt_server.workflows.modflow.model_sustainable_yield_scenario.model_sustainable_yield_scenario import SustainableYieldInputError
