...
logger = logging.getLogger(
    "trid3nt_server.workflows.geoclaw.model_dambreak_geoclaw_scenario.model_dambreak_geoclaw_scenario"
)
...
def _fetch_topo_for_geoclaw(
    ...
    *,
    ...
    from trid3nt_server.tools.fetchers.ocean.fetch_topobathy.fetch_topobathy import fetch_topobathy
