...
logger = logging.getLogger("trid3nt_server.agent.lessons")
...
def _tokenize(text: str) -> list[str]:
    ...
    try:
        from .tools.search.search_tools.search_tools import _tokenize as _dd_tokenize
...
def _content_tokens(tokens: list[str]) -> set[str]:
    ...
    try:
        from .tools.search.search_tools.search_tools import _STOPWORDS as stop
    except Exception:  # noqa: BLE001
        stop = {
