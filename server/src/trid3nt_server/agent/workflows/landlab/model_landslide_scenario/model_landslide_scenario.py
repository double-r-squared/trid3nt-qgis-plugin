...
logger = logging.getLogger("trid3nt_server.agent.workflows.landlab.model_landslide_scenario.model_landslide_scenario")
    ...
    *,
    ...
    try:
        ...
        if secondary_cogs and _os.environ.get(
            ...
            try:
                from trid3nt_server.agent.workflows.landlab.postprocess_landlab import publish_landlab_quantities
