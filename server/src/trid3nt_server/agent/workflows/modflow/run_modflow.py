...
logger = logging.getLogger("trid3nt_server.agent.workflows.modflow.run_modflow")
...
_MODFLOW_WORKER_DIR = (
    Path(__file__).resolve().parents[6] / "services" / "workers" / "modflow"
)
...
def _cache_bucket() -> str:
    ...
    from trid3nt_server.agent.tools.cache import CACHE_BUCKET
...
def register_modflow_solver() -> None:
    ...
    """
    from trid3nt_server.agent.tools.simulation.solver.solver import LOCAL_EXEC_WORKFLOW_NAME, SOLVER_WORKFLOW_REGISTRY
