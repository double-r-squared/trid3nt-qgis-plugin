...
logger = logging.getLogger("trid3nt_server.agent.workflows.modflow.river_seepage.river_seepage")
...
async def model_river_seepage_scenario(
    ...
    *,
    ...
    from trid3nt_server.agent.tools.simulation.run_river_seepage_tool.run_river_seepage_tool import (
