...
logger = logging.getLogger("trid3nt_server.agent.workflows.modflow.modflow_mesh")
    ...
    try:
        ...
        ds = xr.Dataset(
            ...
            attrs={
                ...
                "source": "trid3nt_server.agent.workflows.modflow.modflow_mesh",
            },
        )
        ...
        if out_path is not None:
            ...
            tmpdir = Path(tempfile.mkdtemp(prefix="trid3nt_modflowmesh_"))
