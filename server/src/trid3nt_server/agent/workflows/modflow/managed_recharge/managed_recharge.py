...
from trid3nt_server.agent.workflows.modflow.mine_dewatering.mine_dewatering import _normalize_pit_footprint
...
logger = logging.getLogger("trid3nt_server.agent.workflows.modflow.managed_recharge.managed_recharge")
...
TEMPLATE_CARD = TemplateCard(
    question='the groundwater mound a managed-aquifer-recharge (MAR) spreading basin raises',
    required_inputs=['location (or aoi_latlon)', 'basin_footprint_lonlat'],
    knobs='infiltration_rate_m_day, recharge_months, n_periods, aquifer_k_ms, porosity, aquifer_sy',
)


_METADATA = AtomicToolMetadata(
    name="modflow_managed_recharge",
...
async def modflow_managed_recharge(
    location: str | None = None,
    ...
    **_extra_ignored: Any,
    ...
    Do NOT use this for:
        ...
        - Aquifer storage & recovery cycling (use ``modflow_asr``).
