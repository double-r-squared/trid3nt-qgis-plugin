...
logger = logging.getLogger(
    "trid3nt_server.agent.workflows.modflow.wetland_hydroperiod.wetland_hydroperiod"
)
...
TEMPLATE_CARD = TemplateCard(
    question="a wetland's seasonal water-table range (hydroperiod) under changing groundwater",
    required_inputs=['location (or aoi_latlon)', 'wetland_footprint_lonlat'],
    knobs='recharge_schedule_m_day, et_surface_m, et_max_rate_m_day, et_extinction_depth_m, n_periods, aquifer_k_ms, porosity, specific_yield',
)


_METADATA = AtomicToolMetadata(
    name="modflow_wetland_hydroperiod",
...
async def modflow_wetland_hydroperiod(
    location: str | None = None,
