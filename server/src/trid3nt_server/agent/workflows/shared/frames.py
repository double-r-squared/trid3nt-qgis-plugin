...
logger = logging.getLogger("trid3nt_server.agent.workflows.shared.frames")
...
_cap_logger = logging.getLogger("trid3nt_server.agent.workflows.sfincs.postprocess_flood")
