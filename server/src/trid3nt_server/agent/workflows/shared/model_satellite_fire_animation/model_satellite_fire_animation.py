...
logger = logging.getLogger("trid3nt_server.agent.workflows.shared.model_satellite_fire_animation.model_satellite_fire_animation")
...
def _peek_frame_count(
    ...
    try:
        if _is_polar_product(product):
            ...
            from trid3nt_server.agent.tools.fetchers.imagery.fetch_goes_animation.fetch_goes_animation import (
