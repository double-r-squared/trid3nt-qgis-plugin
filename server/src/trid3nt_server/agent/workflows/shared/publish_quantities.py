...
(``trid3nt_contracts.output_quantities``). It walks ``get_output_registry(engine)``,
...
from trid3nt_server.agent.workflows.shared import cog_io, frames

logger = logging.getLogger("trid3nt_server.agent.workflows.shared.publish_quantities")
