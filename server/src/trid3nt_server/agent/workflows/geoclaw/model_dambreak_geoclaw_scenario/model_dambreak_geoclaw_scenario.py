...
logger = logging.getLogger(
    "trid3nt_server.agent.workflows.geoclaw.model_dambreak_geoclaw_scenario.model_dambreak_geoclaw_scenario"
)
...
def _rasterize_topo_to_depth_grid(
    ...
    from trid3nt_server.agent.workflows.geoclaw.run_geoclaw import _dem_uri_to_local
