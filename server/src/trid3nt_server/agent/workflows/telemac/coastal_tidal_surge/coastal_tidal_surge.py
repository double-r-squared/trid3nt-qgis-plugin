...
from trid3nt_server.agent.workflows.telemac.run_telemac import TELEMAC_COASTAL_SOLVER_NAME

logger = logging.getLogger("trid3nt_server.agent.workflows.telemac.coastal_tidal_surge")
