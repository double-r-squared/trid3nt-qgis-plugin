...
logger = logging.getLogger("trid3nt_server.agent.tools.search.catalog_common")
...
def _default_catalog_yaml_path() -> Path:
    ...
    # server/src/trid3nt_server/agent/tools/search/catalog_common.py -> repo
    ...
    for parent in [here, *here.parents]:
        ...
        if candidate.exists():
            return candidate
    return here.parents[6] / "public_data_source_catalog.yaml"
