...
catalog cache live in ``trid3nt_server.agent.tools.search.catalog_common``.
"""
...
logger = logging.getLogger("trid3nt_server.agent.tools.search.search_data_catalog.search_data_catalog")
