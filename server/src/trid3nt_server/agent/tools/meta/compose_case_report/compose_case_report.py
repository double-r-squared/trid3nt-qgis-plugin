...
from trid3nt_server.agent.tools.processing.query_point_hazard.query_point_hazard import layers_from_case, resolve_case_id
...
logger = logging.getLogger("trid3nt_server.agent.tools.meta.compose_case_report.compose_case_report")
...
async def compose_case_report(
    ...
    **Errors (FR-AS-11):** ``CaseReportInputError`` (no case identifiable),
    ...
    from trid3nt_server.agent.tools.processing.compute_exposure_summary.compute_exposure_summary import get_session_exposure
