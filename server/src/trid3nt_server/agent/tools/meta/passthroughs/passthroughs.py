...
logger = logging.getLogger("trid3nt_server.agent.tools.meta.passthroughs.passthroughs")
...
def _run_qgis_process_docker(
    ...
    try:
        ...
        if proc.returncode == 0 and output_keys:
            from trid3nt_server.agent.tools.simulation.solver.solver import _get_s3_client, _upload_file_s3
