"""``fetch_goes_satellite`` atomic tool — GOES-16/17/18/19 satellite imagery.
"""
...
logger = logging.getLogger("trid3nt_server.agent.tools.fetchers.imagery.fetch_goes_satellite.fetch_goes_satellite")
