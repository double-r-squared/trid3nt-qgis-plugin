...
logger = logging.getLogger("trid3nt_server.agent.tools.fetchers.ocean.fetch_noaa_coops_tides.fetch_noaa_coops_tides")
...
def _build_flatgeobuf(
    ...
    try:
        with tempfile.NamedTemporaryFile(
            suffix=".fgb", delete=False, prefix="trid3nt_coops_"
        ) as f:
            tmp_fgb = f.name
        try:
