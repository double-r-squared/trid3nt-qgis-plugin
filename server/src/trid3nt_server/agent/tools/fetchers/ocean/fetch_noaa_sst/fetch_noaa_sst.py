...
logger = logging.getLogger("trid3nt_server.agent.tools.fetchers.ocean.fetch_noaa_sst.fetch_noaa_sst")
...
def _nc_to_cog_bytes(
    ...
    try:
        fd, tmp_nc = tempfile.mkstemp(suffix=".nc", prefix="trid3nt_sst_")
        ...
        try:
            ...
            fd2, out_path = tempfile.mkstemp(suffix=".tif", prefix="trid3nt_sst_")
            os.close(fd2)
            try:
                da.rio.to_raster(
                    out_path,
