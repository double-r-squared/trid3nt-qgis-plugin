...
logger = logging.getLogger("trid3nt_server.agent.tools.fetchers.biodiversity.fetch_gbif_occurrences.fetch_gbif_occurrences")
...
def _records_to_flatgeobuf_bytes(
    ...
    try:
        with tempfile.NamedTemporaryFile(
            suffix=".fgb", delete=False, prefix="trid3nt_gbif_"
        ) as fgb_f:
            tmp_fgb = fgb_f.name
        try:
