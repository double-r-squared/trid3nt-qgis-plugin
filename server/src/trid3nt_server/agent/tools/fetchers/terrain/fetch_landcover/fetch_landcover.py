...
logger = logging.getLogger("trid3nt_server.agent.tools.fetchers.terrain.fetch_landcover.fetch_landcover")
...
def _landcover_bytes_to_cog(
    ...
    try:
        from trid3nt_server.agent.tools.processing.compute_hillshade.compute_hillshade import _get_gdaldem_bin, _translate_to_cog
