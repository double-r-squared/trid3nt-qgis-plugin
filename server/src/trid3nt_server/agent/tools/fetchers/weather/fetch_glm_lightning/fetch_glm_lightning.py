...
from trid3nt_server.agent.tools.fetchers.imagery.fetch_goes_satellite.fetch_goes_satellite import GOESInputError, _normalize_satellite
...
logger = logging.getLogger("trid3nt_server.agent.tools.fetchers.weather.fetch_glm_lightning.fetch_glm_lightning")
...
def _glm_s3_client() -> Any:
    ...
    from trid3nt_server.agent.tools.fetchers._public_s3 import public_s3_client
