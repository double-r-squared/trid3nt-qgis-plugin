...
logger = logging.getLogger("trid3nt_server.agent.tools.fetchers.weather.fetch_hrrr_forecast.fetch_hrrr_forecast")
...
def _write_da_to_cog_bytes(
    ...
    *,
    ...
    out_fd, out_path = tempfile.mkstemp(suffix=".tif", prefix="trid3nt_hrrr_")
    os.close(out_fd)
    try:
