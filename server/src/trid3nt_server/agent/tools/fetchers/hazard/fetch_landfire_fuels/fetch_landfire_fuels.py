"""``fetch_landfire_fuels`` atomic tool — LANDFIRE fuels & vegetation fetcher.
"""
...
logger = logging.getLogger("trid3nt_server.agent.tools.fetchers.hazard.fetch_landfire_fuels.fetch_landfire_fuels")
