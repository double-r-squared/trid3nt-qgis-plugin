"""``fetch_mtbs_burn_severity`` atomic tool — MTBS burn-severity polygon fetcher.
"""
...
logger = logging.getLogger("trid3nt_server.agent.tools.fetchers.hazard.fetch_mtbs_burn_severity.fetch_mtbs_burn_severity")
