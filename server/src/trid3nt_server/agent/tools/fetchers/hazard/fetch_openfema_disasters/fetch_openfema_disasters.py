...
logger = logging.getLogger("trid3nt_server.agent.tools.fetchers.hazard.fetch_openfema_disasters.fetch_openfema_disasters")
    ...
    *,
    ...
    try:
        with tempfile.NamedTemporaryFile(
            suffix=".fgb", delete=False, prefix="trid3nt_openfema_"
        ) as f:
            tmp_fgb = f.name
