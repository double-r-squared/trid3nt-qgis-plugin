...
logger = logging.getLogger("trid3nt_server.agent.tools.fetchers.hazard.fetch_hifld_transmission_lines.fetch_hifld_transmission_lines")
...
def fetch_hifld_transmission_lines(
    ...
    **When to use:**
    ...
    - A hazard / exposure workflow needs the transmission network inside a flood
      ...
      ``compute_zonal_statistics`` or ``spatial_query``).
