"""``fetch_gcn250_curve_numbers`` atomic tool — GCN250 global SCS curve-numbers.
"""
...
logger = logging.getLogger("trid3nt_server.agent.tools.fetchers.soil.fetch_gcn250_curve_numbers.fetch_gcn250_curve_numbers")
        ...
        with rasterio.Env(**gdal_env):
            ...
            try:
                ...
                out_fd, out_path = tempfile.mkstemp(
                    suffix=".tif", prefix="trid3nt_gcn250_"
                )
                os.close(out_fd)
                try:
                    profile = {
