"""``fetch_hrsl_population`` atomic tool — Meta + CIESIN HRSL population fetcher.
"""
...
logger = logging.getLogger("trid3nt_server.agent.tools.fetchers.socioeconomic.fetch_hrsl_population.fetch_hrsl_population")
