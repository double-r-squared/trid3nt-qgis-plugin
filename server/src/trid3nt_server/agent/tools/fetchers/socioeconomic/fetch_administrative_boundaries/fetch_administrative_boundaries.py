...
logger = logging.getLogger("trid3nt_server.agent.tools.fetchers.socioeconomic.fetch_administrative_boundaries.fetch_administrative_boundaries")
...
def _download_and_clip_zip(
    ...
    try:
        ...
        with tempfile.NamedTemporaryFile(
            suffix=".zip", delete=False, prefix="trid3nt_tiger_"
        ) as zf:
            tmp_zip = zf.name
        ...
        tmp_dir = tempfile.mkdtemp(prefix="trid3nt_tiger_")
        try:
        ...
        with tempfile.NamedTemporaryFile(
            suffix=".fgb", delete=False, prefix="trid3nt_tiger_clip_"
        ) as fgb_f:
            tmp_fgb = fgb_f.name
