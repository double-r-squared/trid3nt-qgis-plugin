...
logger = logging.getLogger("trid3nt_server.agent.tools.fetchers.socioeconomic.geocode_location.geocode_location")
...
def _extract_us_state(query: str) -> str | None:
    ...
    from trid3nt_server.agent.tools.fetchers.us_states import STATE_CODE_TO_NAME, STATE_NAME_TO_CODE
    ...
    from trid3nt_server.agent.tools.fetchers.us_states import resolve_state_code
