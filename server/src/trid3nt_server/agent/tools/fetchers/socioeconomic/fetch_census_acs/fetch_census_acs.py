"""``fetch_census_acs`` atomic tool -- US Census ACS 5-year demographics as a census-tract choropleth FlatGeobuf.
"""
...
logger = logging.getLogger("trid3nt_server.agent.tools.fetchers.socioeconomic.fetch_census_acs.fetch_census_acs")
