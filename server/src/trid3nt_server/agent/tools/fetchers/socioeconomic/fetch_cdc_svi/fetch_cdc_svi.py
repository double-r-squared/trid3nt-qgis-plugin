...
logger = logging.getLogger("trid3nt_server.agent.tools.fetchers.socioeconomic.fetch_cdc_svi.fetch_cdc_svi")
...
def fetch_cdc_svi(
    ...
    **Cross-tool dependencies:**
        - Feeds INTO: ``compute_zonal_statistics`` (vulnerable population inside
          a hazard footprint), ``spatial_query`` (admin-bounded SVI).
