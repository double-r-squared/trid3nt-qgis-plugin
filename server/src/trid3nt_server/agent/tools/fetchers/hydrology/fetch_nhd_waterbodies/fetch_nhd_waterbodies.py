...
logger = logging.getLogger("trid3nt_server.agent.tools.fetchers.hydrology.fetch_nhd_waterbodies.fetch_nhd_waterbodies")
    ...
    **_extra_ignored: Any,
    ...
    Cross-tool dependencies:
        ...
        - Feeds ``compute_zonal_statistics`` (waterbody area inside a footprint)
          and ``spatial_query`` (waterbodies within a place).
