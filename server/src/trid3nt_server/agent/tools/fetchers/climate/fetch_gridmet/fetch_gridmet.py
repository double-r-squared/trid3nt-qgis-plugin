...
logger = logging.getLogger("trid3nt_server.agent.tools.fetchers.climate.fetch_gridmet.fetch_gridmet")
...
def _da_to_cog_bytes(da, variable: str) -> bytes:
    ...
    out_fd, out_path = tempfile.mkstemp(suffix=".tif", prefix="trid3nt_gridmet_")
    os.close(out_fd)
    try:
        # Tag metadata.
