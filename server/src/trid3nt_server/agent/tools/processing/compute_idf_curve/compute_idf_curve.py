...
from trid3nt_server.agent.tools.fetchers.climate.lookup_precip_return_period import lookup_precip_return_period as _df
...
logger = logging.getLogger("trid3nt_server.agent.tools.processing.compute_idf_curve.compute_idf_curve")
