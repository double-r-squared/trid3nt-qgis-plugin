...
logger = logging.getLogger("trid3nt_server.agent.tools.processing.compute_layer_bounds.compute_layer_bounds")
...
def _bounds_from_vector(path: str) -> tuple[float, float, float, float]:
    ...
    from trid3nt_server.agent.tools.simulation.pelicun.postprocess_pelicun.postprocess_pelicun import _bbox_from_gdf
