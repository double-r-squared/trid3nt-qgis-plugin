# trid3nt_server.tools — atomic-tool registry + cache shim
...
`trid3nt_contracts.tool_registry`; this package consumes it.
...
Importing `trid3nt_server.tools` triggers the import-time `@register_tool`
