...
from trid3nt_server.tools.discovery.search_tools.search_tools import _tokenize
...
logger = logging.getLogger("trid3nt_server.tools.discovery.search_spatial_functions.search_spatial_functions")
...
def _default_data_path() -> Path:
    ...
    # tools/discovery/search_spatial_functions/search_spatial_functions.py
    # -> trid3nt_server/ is parents[3]
    here = Path(__file__).resolve()
    return here.parents[3] / "data" / "duckdb_spatial_functions.json"
