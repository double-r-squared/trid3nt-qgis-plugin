...
logger = logging.getLogger("trid3nt_server.tools.meta.import_user_layer.import_user_layer")
...
async def _ingest_vector(
    *,
    ...
    from trid3nt_server.tools.simulation.solver.solver import _get_runs_bucket
