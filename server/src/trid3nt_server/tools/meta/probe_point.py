...
from trid3nt_server.tools.processing.extract_timeseries_at_point import detect_frame_sequences
...
logger = logging.getLogger("trid3nt_server.tools.meta.probe_point")
