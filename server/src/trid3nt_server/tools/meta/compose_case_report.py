...
from trid3nt_server.tools.processing.query_point_hazard import layers_from_case, resolve_case_id
...
logger = logging.getLogger("trid3nt_server.tools.meta.compose_case_report")
...
def _layer_stats_line(layer: dict[str, Any], tmpdir: str) -> str:
    ...
    from trid3nt_server.tools.meta.export_case_to_qgis import _strip_query, _unwrap_tile_template
...
async def compose_case_report(
    ...
    **Errors (FR-AS-11):** ``CaseReportInputError`` (no case identifiable),
    ...
    from trid3nt_server.tools.processing.compute_exposure_summary import get_session_exposure
