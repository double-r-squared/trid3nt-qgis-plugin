...
logger = logging.getLogger("trid3nt_server.tools.meta.export_case_to_qgis.export_case_to_qgis")
...
def _resolve_mesh_crs(bucket: str, mesh_key: str) -> str | None:
    ...
    try:
        ...
        from trid3nt_server.workflows.sfincs.postprocess_flood import _read_crs_from_dataset
