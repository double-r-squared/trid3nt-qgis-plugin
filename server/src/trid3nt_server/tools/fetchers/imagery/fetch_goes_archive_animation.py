...
from trid3nt_server.tools.fetchers.imagery.fetch_goes_satellite import (
    _KEY_START_TIME_RE,
    _PRODUCT_PREFIX,
    _SATELLITE_BUCKETS,
    _doy_hour,
...
logger = logging.getLogger("trid3nt_server.tools.fetchers.imagery.fetch_goes_archive_animation")
