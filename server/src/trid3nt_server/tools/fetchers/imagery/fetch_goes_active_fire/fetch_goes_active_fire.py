...
from trid3nt_server.tools.fetchers.imagery.fetch_goes_satellite.fetch_goes_satellite import _normalize_satellite
...
logger = logging.getLogger("trid3nt_server.tools.fetchers.imagery.fetch_goes_active_fire.fetch_goes_active_fire")
