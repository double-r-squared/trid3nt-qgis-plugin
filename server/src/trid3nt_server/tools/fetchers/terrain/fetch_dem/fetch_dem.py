...
logger = logging.getLogger("trid3nt_server.tools.fetchers.terrain.fetch_dem.fetch_dem")
...
def fetch_dem(
    ...
    **Cross-tool dependencies:**
    ...
    if src in _DEM_SOURCE_COPERNICUS_ALIASES:
        from trid3nt_server.tools.fetchers.terrain.fetch_copernicus_dem.fetch_copernicus_dem import _copernicus_dem_impl
