...
from trid3nt_server.tools.fetchers.imagery.fetch_goes_satellite.fetch_goes_satellite import GOESInputError, _normalize_satellite
...
logger = logging.getLogger("trid3nt_server.tools.fetchers.weather.fetch_glm_lightning.fetch_glm_lightning")
