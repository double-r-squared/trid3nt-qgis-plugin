...
logger = logging.getLogger("trid3nt_server.tools.processing.analyze_affected_fields.analyze_affected_fields")
...
def _default_threshold_mgl() -> float:
    ...
    try:
        from trid3nt_server.workflows.modflow.postprocess_modflow import PLUME_DETECTION_FLOOR_MGL
