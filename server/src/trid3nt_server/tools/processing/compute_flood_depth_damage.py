...
logger = logging.getLogger("trid3nt_server.tools.processing.compute_flood_depth_damage")
...
def _load_assets(
    ...
    if assets_uri is not None:
        ...
        try:
            from trid3nt_server.tools.fetchers.socioeconomic.fetch_usace_nsi import fetch_usace_nsi
