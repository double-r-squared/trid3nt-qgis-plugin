...
logger = logging.getLogger("trid3nt_server.tools.processing.compute_layer_bounds")
...
def _bounds_from_vector(path: str) -> tuple[float, float, float, float]:
    ...
    from trid3nt_server.tools.simulation.postprocess_pelicun import _bbox_from_gdf
