...
from trid3nt_server.tools.processing.compute_hillshade.compute_hillshade import _download_dem_bytes, _gdaldem_subprocess_env
...
logger = logging.getLogger("trid3nt_server.tools.processing.compute_contours.compute_contours")
...
def _get_gdal_contour_bin() -> str:
    ...
    try:
        from trid3nt_server.tools.processing.compute_hillshade.compute_hillshade import _get_gdaldem_bin
