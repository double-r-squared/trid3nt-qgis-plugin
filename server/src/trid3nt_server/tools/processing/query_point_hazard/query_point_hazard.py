...
logger = logging.getLogger("trid3nt_server.tools.processing.query_point_hazard.query_point_hazard")
...
def stage_layer_local(uri: str, tmpdir: str, label: str) -> str:
    ...
    """
    from trid3nt_server.tools.meta.export_case_to_qgis.export_case_to_qgis import _strip_query, _unwrap_tile_template
