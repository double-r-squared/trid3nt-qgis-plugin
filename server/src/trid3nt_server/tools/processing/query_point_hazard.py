...
logger = logging.getLogger("trid3nt_server.tools.processing.query_point_hazard")
...
def _geocode_place(place: str) -> dict[str, Any]:
    ...
    """
    from trid3nt_server.tools.fetchers.socioeconomic.geocode_location import geocode_location
...
def resolve_case_id(case_id: Any, error_cls: type[Exception] = NoCaseBoundError) -> str:
    ...
    try:
        from trid3nt_server.pipeline_emitter import current_turn_case
