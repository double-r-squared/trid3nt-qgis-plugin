...
from trid3nt_server.tools.processing.compute_hillshade import _gdaldem_subprocess_env, _translate_to_cog

__all__ = ["compute_colored_relief"]

logger = logging.getLogger("trid3nt_server.tools.processing.compute_colored_relief")
