...
``TRID3NT_ENABLE_EXAMPLE_TOOL`` env flag so this example NEVER pollutes the
...
check with ``TRID3NT_ENABLE_EXAMPLE_TOOL=1``.
...
def example_bbox_area(
    ...
    **Cross-tool dependencies:** none -- this is a self-contained primitive.
    ...
    # A real tool imports ToolInputError from trid3nt_contracts.tool_registry (or
