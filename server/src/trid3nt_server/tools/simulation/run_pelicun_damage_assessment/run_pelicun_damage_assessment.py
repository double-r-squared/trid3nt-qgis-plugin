...
logger = logging.getLogger("trid3nt_server.tools.simulation.run_pelicun_damage_assessment.run_pelicun_damage_assessment")
...
def run_pelicun_damage_assessment(
    ...
    **_extra_ignored: Any,
    ...
    ``run_pelicun_with_buildings`` chains building-density fetch -> this
    tool in one call.
