...
logger = logging.getLogger("trid3nt_server.tools.simulation.model_debris_flow.model_debris_flow")
...
def _severity_from_mtbs(
    ...
    try:
        from trid3nt_server.tools.fetchers.hazard.fetch_mtbs_burn_severity.fetch_mtbs_burn_severity import MTBSError, fetch_mtbs_burn_severity
    except Exception as exc:  # noqa: BLE001
...
def _load_kf(
    ...
    try:
        from trid3nt_server.tools.fetchers.soil.fetch_statsgo_soils.fetch_statsgo_soils import fetch_statsgo_soils
