...
from trid3nt_server.workflows.telemac.model_river_dye_release_scenario.model_river_dye_release_scenario import (
    TelemacDyeScenarioError,
    model_river_dye_release_scenario,
    plausible_release_coords,
)
from trid3nt_server.workflows.telemac.postprocess_telemac import PostprocessTelemacError

logger = logging.getLogger("trid3nt_server.tools.simulation.run_telemac_tool.run_telemac_tool")
...
async def run_telemac(
    ...
    **_extra_ignored: Any,
    ...
    if contaminant:
        from trid3nt_server.workflows.telemac.model_river_dye_release_scenario.model_river_dye_release_scenario import (  # noqa: WPS433
            classify_substance,
        )
