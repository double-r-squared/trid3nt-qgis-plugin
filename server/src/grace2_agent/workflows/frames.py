...
contract every engine's postprocess shares:
  ...
  - ``MAX_FLOOD_FRAMES`` (env ``GRACE2_MAX_FLOOD_FRAMES``) - the upper bound on
...
logger = logging.getLogger("grace2_agent.workflows.frames")
...
_cap_logger = logging.getLogger("grace2_agent.workflows.postprocess_flood")
