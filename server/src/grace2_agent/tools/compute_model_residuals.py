...
from grace2_contracts.execution import LayerURI, LegendKey
...
logger = logging.getLogger("grace2_agent.tools.compute_model_residuals")
...
def compute_model_residuals(
    ...
    **Errors (FR-AS-11):** ``ResidualsInputError`` (bad/unreadable inputs, no
    ...
    with tempfile.TemporaryDirectory(prefix="grace2_model_residuals_") as tmpdir:
