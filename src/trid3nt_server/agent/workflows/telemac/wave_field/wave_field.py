...
from trid3nt_server.agent.workflows.telemac.run_telemac import TOMAWAC_SOLVER_NAME

logger = logging.getLogger("trid3nt_server.agent.workflows.telemac.wave_field")
